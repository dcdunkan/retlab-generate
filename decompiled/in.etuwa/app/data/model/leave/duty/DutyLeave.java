...
/* JADX INFO: compiled from: DutyLeave.kt */
...
public final /* data */ class DutyLeave {
    ...
    public int hashCode() {
        int iHashCode = ((((((((((this.id.hashCode() * 31) + this.name.hashCode()) * 31) + this.type.hashCode()) * 31) + this.description.hashCode()) * 31) + this.status.hashCode()) * 31) + this.lastDate.hashCode()) * 31;
        ...
        return ((i + (z2 ? 1 : z2)) * 31) + this.proofUrl.hashCode();
    }
