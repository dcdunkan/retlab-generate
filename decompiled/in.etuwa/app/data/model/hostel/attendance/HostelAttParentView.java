...
public final /* data */ class HostelAttParentView {
    ...
    private final ArrayList<HostelDates> dates;
    ...
    public final ArrayList<HostelDates> component9() {
        return this.dates;
    }

    public final HostelAttParentView copy(String id, String type, String from_date, String status, String reason, String btn_app, String btn_rej, String btn_rev, ArrayList<HostelDates> dates) {
        ...
        return new HostelAttParentView(id, type, from_date, status, reason, btn_app, btn_rej, btn_rev, dates);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.id, hostelAttParentView.id) && Intrinsics.areEqual(this.type, hostelAttParentView.type) && Intrinsics.areEqual(this.from_date, hostelAttParentView.from_date) && Intrinsics.areEqual(this.status, hostelAttParentView.status) && Intrinsics.areEqual(this.reason, hostelAttParentView.reason) && Intrinsics.areEqual(this.btn_app, hostelAttParentView.btn_app) && Intrinsics.areEqual(this.btn_rej, hostelAttParentView.btn_rej) && Intrinsics.areEqual(this.btn_rev, hostelAttParentView.btn_rev) && Intrinsics.areEqual(this.dates, hostelAttParentView.dates);
    }

    public int hashCode() {
        return (((((((((((((((this.id.hashCode() * 31) + this.type.hashCode()) * 31) + this.from_date.hashCode()) * 31) + this.status.hashCode()) * 31) + this.reason.hashCode()) * 31) + this.btn_app.hashCode()) * 31) + this.btn_rej.hashCode()) * 31) + this.btn_rev.hashCode()) * 31) + this.dates.hashCode();
    }

    public String toString() {
        return "HostelAttParentView(id=" + this.id + ", type=" + this.type + ", from_date=" + this.from_date + ", status=" + this.status + ", reason=" + this.reason + ", btn_app=" + this.btn_app + ", btn_rej=" + this.btn_rej + ", btn_rev=" + this.btn_rev + ", dates=" + this.dates + ")";
    }

    public HostelAttParentView(String id, String type, String from_date, String status, String reason, String btn_app, String btn_rej, String btn_rev, ArrayList<HostelDates> dates) {
        Intrinsics.checkNotNullParameter(id, "id");
        Intrinsics.checkNotNullParameter(type, "type");
        Intrinsics.checkNotNullParameter(from_date, "from_date");
        Intrinsics.checkNotNullParameter(status, "status");
    ...
    public final ArrayList<HostelDates> getDates() {
        return this.dates;
    }
}