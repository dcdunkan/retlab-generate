...
/* JADX INFO: compiled from: LoginRepository.kt */
...
public final class LoginRepository implements KoinComponent {
    ...
    public LoginRepository(ApiHelper apiHelper) {
        ...
        this.preference = LazyKt.lazy(lazyThreadSafetyModeDefaultLazyMode, (Function0) new Function0<SharedPrefManager>() { // from class: in.etuwa.app.data.repository.LoginRepository$special$$inlined$inject$default$1
            ...
            public final SharedPrefManager invoke() {
                Scope rootScope;
                KoinComponent koinComponent = loginRepository;
