...
import in.etuwa.app.data.model.profileasiet.coursesattended.CoursesAttended;
...
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0002\u001a\u001bB\u0005¢\u0006\u0002\u0010\u0003J\u001e\u0010\n\u001a\u00020\u000b2\u0016\u0010\f\u001a\u0012\u0012\u0004\u0012\u00020\u00060\u0005j\b\u0012\u0004\u0012\u00020\u0006`\u0007J\b\u0010\r\u001a\u00020\u000eH\u0016J\u0010\u0010\u000f\u001a\u00020\u000e2\u0006\u0010\u0010\u001a\u00020\u000eH\u0016J\u0018\u0010\u0011\u001a\u00020\u000b2\u0006\u0010\u0012\u001a\u00020\u00022\u0006\u0010\u0010\u001a\u00020\u000eH\u0016J\u0018\u0010\u0013\u001a\u00020\u00022\u0006\u0010\u0014\u001a\u00020\u00152\u0006\u0010\u0016\u001a\u00020\u000eH\u0016J\u0010\u0010\u0017\u001a\u00020\u000b2\b\u0010\u0018\u001a\u0004\u0018\u00010\u0019R\u001e\u0010\u0004\u001a\u0012\u0012\u0004\u0012\u00020\u00060\u0005j\b\u0012\u0004\u0012\u00020\u0006`\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\b\u001a\u0004\u0018\u00010\tX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u001c"}, d2 = {"Lin/etuwa/app/ui/profile/coursesattended/CoursesAttendedAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lin/etuwa/app/ui/base/BaseViewHolder;", "()V", "coursesAttended", "Ljava/util/ArrayList;", "Lin/etuwa/app/data/model/profileasiet/coursesattended/CoursesAttended;", "Lkotlin/collections/ArrayList;", ServiceSpecificExtraArgs.CastExtraArgs.LISTENER, "Lin/etuwa/app/ui/profile/coursesattended/CoursesAttendedAdapter$CoursesListener;", "addItems", "", "list", "getItemCount", "", "getItemViewType", CommonCssConstants.POSITION, "onBindViewHolder", "holder", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "setCoursesListener", "context", "Lin/etuwa/app/ui/profile/coursesattended/CoursesAttendedFragment;", "CoursesListener", "ViewHolder", "app_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class CoursesAttendedAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public interface CoursesListener {
        ...
        void editBtnClicked(String id, String name, String organised, String duration, String achievements, String fromDate, String toDate);
    }
    ...
    public int getItemCount() {
        if (this.coursesAttended.size() > 0) {
            return this.coursesAttended.size();
        }
        return 1;
    }
    ...
    public final class ViewHolder extends BaseViewHolder {
        ...
        final /* synthetic */ CoursesAttendedAdapter this$0;
        ...
        public ViewHolder(CoursesAttendedAdapter coursesAttendedAdapter, View itemView) {
            super(itemView);
            Intrinsics.checkNotNullParameter(itemView, "itemView");
            this.this$0 = coursesAttendedAdapter;
            ...
            this.academicYear = (TextView) itemView.findViewById(R.id.academic_tv);
        ...
        public void onBind(int position) {
            ...
            try {
                Object obj = this.this$0.coursesAttended.get(position);
                Intrinsics.checkNotNullExpressionValue(obj, "coursesAttended[position]");
                final CoursesAttended coursesAttended = (CoursesAttended) obj;
                this.title.setText(coursesAttended.getName());
                this.organisedBy.setText(coursesAttended.getOrganized_by());
                this.fromDate.setText(coursesAttended.getFrom_date());
                this.toDate.setText(coursesAttended.getTo_date());
                this.durationTv.setText(coursesAttended.getDuration());
                this.achievements.setText(coursesAttended.getAchievements());
                this.academicYear.setText(coursesAttended.getYear());
                if (Intrinsics.areEqual(coursesAttended.getFile(), "")) {
                ...
                if (textView != null) {
                    final CoursesAttendedAdapter coursesAttendedAdapter = this.this$0;
                ...
                if (textView2 != null) {
                    final CoursesAttendedAdapter coursesAttendedAdapter2 = this.this$0;
                ...
                if (textView3 != null) {
                    final CoursesAttendedAdapter coursesAttendedAdapter3 = this.this$0;
        ...
        public static final void onBind$lambda$0(CoursesAttendedAdapter this$0, CoursesAttended coursesAttended, View view) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            Intrinsics.checkNotNullParameter(coursesAttended, "$coursesAttended");
            CoursesListener coursesListener = this$0.listener;
            if (coursesListener != null) {
                coursesListener.downloadFile(coursesAttended.getFile(), coursesAttended.getFile());
            }
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final void onBind$lambda$1(CoursesAttendedAdapter this$0, CoursesAttended coursesAttended, View view) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            Intrinsics.checkNotNullParameter(coursesAttended, "$coursesAttended");
            CoursesListener coursesListener = this$0.listener;
            if (coursesListener != null) {
                coursesListener.editBtnClicked(coursesAttended.getId(), coursesAttended.getName(), coursesAttended.getOrganized_by(), coursesAttended.getDuration(), coursesAttended.getAchievements(), coursesAttended.getFrom_date(), coursesAttended.getTo_date());
            }
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final void onBind$lambda$2(CoursesAttendedAdapter this$0, CoursesAttended coursesAttended, View view) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            Intrinsics.checkNotNullParameter(coursesAttended, "$coursesAttended");
            CoursesListener coursesListener = this$0.listener;
            if (coursesListener != null) {
                coursesListener.deleteBtnClicked(coursesAttended.getId());
            }
        }
    }
    ...
    public final void addItems(ArrayList<CoursesAttended> list) {
        Intrinsics.checkNotNullParameter(list, "list");
        this.coursesAttended.clear();
        this.coursesAttended.addAll(list);
        notifyDataSetChanged();
    }

    public final void setCoursesListener(CoursesAttendedFragment context) {
