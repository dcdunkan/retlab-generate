...
public final class ContactDetailsViewModel extends ViewModel implements KoinComponent {
    ...
    public ContactDetailsViewModel(DashRepository dashRepository) {
