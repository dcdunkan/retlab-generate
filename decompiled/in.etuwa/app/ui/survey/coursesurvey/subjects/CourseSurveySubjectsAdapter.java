...
/* JADX INFO: compiled from: CourseSurveySubjectsAdapter.kt */
...
public final class CourseSurveySubjectsAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View viewInflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_tech_survey, parent, false);
            ...
            try {
                ...
                textView.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.survey.coursesurvey.subjects.CourseSurveySubjectsAdapter$ViewHolder$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(View view) {
                        CourseSurveySubjectsAdapter.ViewHolder.onBind$lambda$0(courseSurveySubjectsAdapter, doCourseSurvey, view);
                    }
                });
