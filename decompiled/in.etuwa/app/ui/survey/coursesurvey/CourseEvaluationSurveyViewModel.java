...
/* compiled from: CourseEvaluationSurveyViewModel.kt */
@Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0012\u0010\u000b\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\n0\t0\bJ\u0006\u0010\f\u001a\u00020\rJ\b\u0010\u000e\u001a\u00020\rH\u0014R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\u0007\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\n0\t0\bX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u000f"}, d2 = {"Lin/etuwa/app/ui/survey/coursesurvey/CourseEvaluationSurveyViewModel;", "Landroidx/lifecycle/ViewModel;", "surveyRepository", "Lin/etuwa/app/data/repository/SurveyRepository;", "(Lin/etuwa/app/data/repository/SurveyRepository;)V", "compositeDisposable", "Lio/reactivex/disposables/CompositeDisposable;", "surveyResponse", "Landroidx/lifecycle/MutableLiveData;", "Lin/etuwa/app/utils/Resource;", "Lin/etuwa/app/data/model/survey/courseevaluation/CourseSurveyResponse;", "getResponse", "getSurveyList", "", "onCleared", "app_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class CourseEvaluationSurveyViewModel extends ViewModel {
    ...
    public final void getSurveyList() {
        ...
        Single<CourseSurveyResponse> observeOn = this.surveyRepository.getCourseSurveyList().subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
        final Function1<CourseSurveyResponse, Unit> function1 = new Function1<CourseSurveyResponse, Unit>() { // from class: in.etuwa.app.ui.survey.coursesurvey.CourseEvaluationSurveyViewModel$getSurveyList$1
            ...
            public final void invoke2(CourseSurveyResponse courseSurveyResponse) {
                ...
                mutableLiveData = CourseEvaluationSurveyViewModel.this.surveyResponse;
                mutableLiveData.postValue(Resource.INSTANCE.success(courseSurveyResponse));
            }
        };
        Consumer<? super CourseSurveyResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.survey.coursesurvey.CourseEvaluationSurveyViewModel$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj) {
                CourseEvaluationSurveyViewModel.getSurveyList$lambda$0(Function1.this, obj);
            }
        };
        ...
        compositeDisposable.add(observeOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.survey.coursesurvey.CourseEvaluationSurveyViewModel$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                CourseEvaluationSurveyViewModel.getSurveyList$lambda$1(Function1.this, obj);
            }
        }));
    }
