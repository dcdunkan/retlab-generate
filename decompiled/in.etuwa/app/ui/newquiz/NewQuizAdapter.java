...
public final class NewQuizAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public interface QuizInteraction {
        ...
        void attemptQuiz(String id);

        void viewResult(String id);
    }
    ...
    public final class ViewHolder extends BaseViewHolder {
        ...
        final /* synthetic */ NewQuizAdapter this$0;
        ...
        public ViewHolder(NewQuizAdapter newQuizAdapter, View itemView) {
            super(itemView);
            Intrinsics.checkNotNullParameter(itemView, "itemView");
            this.this$0 = newQuizAdapter;
        ...
        public static final void onBind$lambda$0(Quiz quiz, NewQuizAdapter this$0, View view) {
            Intrinsics.checkNotNullParameter(quiz, "$quiz");
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            if (quiz.isResultPublished()) {
                QuizInteraction quizInteraction = this$0.listener;
                if (quizInteraction != null) {
                    quizInteraction.viewResult(quiz.getId());
                    return;
                }
                return;
            }
            QuizInteraction quizInteraction2 = this$0.listener;
            if (quizInteraction2 != null) {
                quizInteraction2.attemptQuiz(quiz.getId());
            }
        }
    }
    ...
    public final void setQuizInteraction(NewQuizFragment context) {
