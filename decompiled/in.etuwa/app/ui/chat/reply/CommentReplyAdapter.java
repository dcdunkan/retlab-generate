...
/* JADX INFO: compiled from: CommentReplyAdapter.kt */
...
public final class CommentReplyAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View viewInflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_replys, parent, false);
        Intrinsics.checkNotNullExpressionValue(viewInflate, "from(parent.context).inf…ow_replys, parent, false)");
