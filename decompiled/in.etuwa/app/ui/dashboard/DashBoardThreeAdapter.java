...
/* JADX INFO: compiled from: DashBoardThreeAdapter.kt */
/* JADX INFO: loaded from: classes4.dex */
public final class DashBoardThreeAdapter extends RecyclerView.Adapter<BaseViewHolder> implements KoinComponent {
    ...
    /* JADX INFO: compiled from: DashBoardThreeAdapter.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, d2 = {"Lin/etuwa/app/ui/dashboard/DashBoardThreeAdapter$CallBack;", "", "onDashItemClickedNew", "", "title", "", "app_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public interface CallBack {
        void onDashItemClickedNew(String title);
    }

    public DashBoardThreeAdapter() {
        final DashBoardThreeAdapter dashBoardThreeAdapter = this;
        LazyThreadSafetyMode lazyThreadSafetyModeDefaultLazyMode = KoinPlatformTools.INSTANCE.defaultLazyMode();
        final Qualifier qualifier = null;
        final byte b = 0 == true ? 1 : 0;
        this.preference = LazyKt.lazy(lazyThreadSafetyModeDefaultLazyMode, (Function0) new Function0<SharedPrefManager>() { // from class: in.etuwa.app.ui.dashboard.DashBoardThreeAdapter$special$$inlined$inject$default$1
            ...
            public final SharedPrefManager invoke() {
                Scope rootScope;
                KoinComponent koinComponent = dashBoardThreeAdapter;
    ...
    public final class ViewHolder extends BaseViewHolder {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public ViewHolder(DashBoardThreeAdapter dashBoardThreeAdapter, View itemView) {
            super(itemView);
            Intrinsics.checkNotNullParameter(itemView, "itemView");
            this.this$0 = dashBoardThreeAdapter;
        ...
        public void onBind(int position) {
            ...
            try {
                ...
                final DashBoardThreeAdapter dashBoardThreeAdapter = this.this$0;
                cardView.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.dashboard.DashBoardThreeAdapter$ViewHolder$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        DashBoardThreeAdapter.ViewHolder.onBind$lambda$0(dashBoardThreeAdapter, str, view);
                    }
                });
        ...
        public static final void onBind$lambda$0(DashBoardThreeAdapter this$0, String title, View view) {
