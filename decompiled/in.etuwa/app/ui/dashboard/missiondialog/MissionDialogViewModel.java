...
public final class MissionDialogViewModel extends ViewModel implements KoinComponent {
    ...
    public MissionDialogViewModel(DashRepository dashRepository) {
        ...
        final MissionDialogViewModel missionDialogViewModel = this;
        LazyThreadSafetyMode defaultLazyMode = KoinPlatformTools.INSTANCE.defaultLazyMode();
        final Qualifier qualifier = null;
        final byte b = 0 == true ? 1 : 0;
        this.preference = LazyKt.lazy(defaultLazyMode, (Function0) new Function0<SharedPrefManager>() { // from class: in.etuwa.app.ui.dashboard.missiondialog.MissionDialogViewModel$special$$inlined$inject$default$1
    ...
    public final void getDashData(String hostel) {
        ...
        final Function1<DashResponse, Unit> function1 = new Function1<DashResponse, Unit>() { // from class: in.etuwa.app.ui.dashboard.missiondialog.MissionDialogViewModel$getDashData$1
            {
                super(1);
            }
            ...
            public final void invoke2(DashResponse dashResponse) {
                MissionDialogViewModel.this.getDashResponse().postValue(Resource.INSTANCE.success(dashResponse));
            }
        };
        Consumer<? super DashResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.dashboard.missiondialog.MissionDialogViewModel$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MissionDialogViewModel.getDashData$lambda$0(Function1.this, obj);
            }
        };
        final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: in.etuwa.app.ui.dashboard.missiondialog.MissionDialogViewModel$getDashData$2
            {
                super(1);
            }
            ...
            public final void invoke2(Throwable th) {
                MissionDialogViewModel.this.getDashResponse().postValue(Resource.INSTANCE.exception(AppConstant.ERROR_MSG));
            }
        };
        compositeDisposable.add(observeOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.dashboard.missiondialog.MissionDialogViewModel$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MissionDialogViewModel.getDashData$lambda$1(Function1.this, obj);
            }
        }));
    }
