...
@Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u000e\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0012J\u0012\u0010\u0013\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\b0\u00070\u0006J\"\u0010\u0014\u001a\u001e\u0012\u001a\u0012\u0018\u0012\u0014\u0012\u0012\u0012\u0004\u0012\u00020\r0\fj\b\u0012\u0004\u0012\u00020\r`\u000e0\u00070\u0006J\u0006\u0010\u0015\u001a\u00020\u0010J\b\u0010\u0016\u001a\u00020\u0010H\u0014R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\u0005\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\b0\u00070\u0006X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u0004¢\u0006\u0002\n\u0000R*\u0010\u000b\u001a\u001e\u0012\u001a\u0012\u0018\u0012\u0014\u0012\u0012\u0012\u0004\u0012\u00020\r0\fj\b\u0012\u0004\u0012\u00020\r`\u000e0\u00070\u0006X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0017"}, d2 = {"Lin/etuwa/app/ui/attendance/bysubject/AttendanceViewModel;", "Landroidx/lifecycle/ViewModel;", "attendanceRepository", "Lin/etuwa/app/data/repository/AttendanceRepository;", "(Lin/etuwa/app/data/repository/AttendanceRepository;)V", "attendanceResponse", "Landroidx/lifecycle/MutableLiveData;", "Lin/etuwa/app/utils/Resource;", "Lin/etuwa/app/data/model/attendance/AttendanceResponse;", "compositeDisposable", "Lio/reactivex/disposables/CompositeDisposable;", "semResponse", "Ljava/util/ArrayList;", "Lin/etuwa/app/data/model/Semester;", "Lkotlin/collections/ArrayList;", "getAttendance", "", "id", "", "getResponse", "getSemResponse", "getSemester", "onCleared", "app_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class AttendanceViewModel extends ViewModel {
    ...
    public final void getSemester() {
        ...
        final Function1<ArrayList<Semester>, Unit> function1 = new Function1<ArrayList<Semester>, Unit>() { // from class: in.etuwa.app.ui.attendance.bysubject.AttendanceViewModel$getSemester$1
            ...
            public final void invoke2(ArrayList<Semester> arrayList) {
                ...
                mutableLiveData = AttendanceViewModel.this.semResponse;
                mutableLiveData.postValue(Resource.INSTANCE.success(arrayList));
            }
        };
        Consumer<? super ArrayList<Semester>> consumer = new Consumer() { // from class: in.etuwa.app.ui.attendance.bysubject.AttendanceViewModel$$ExternalSyntheticLambda2
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                AttendanceViewModel.getSemester$lambda$0(Function1.this, obj);
            }
        };
        ...
        compositeDisposable.add(observeOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.attendance.bysubject.AttendanceViewModel$$ExternalSyntheticLambda3
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                AttendanceViewModel.getSemester$lambda$1(Function1.this, obj);
            }
        }));
    }
    ...
    public final void getAttendance(String id) {
        ...
        CompositeDisposable compositeDisposable = this.compositeDisposable;
        Single<AttendanceResponse> observeOn = this.attendanceRepository.getAttendanceBySubjectApiCall(new AttendanceRequest(id)).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
        final Function1<AttendanceResponse, Unit> function1 = new Function1<AttendanceResponse, Unit>() { // from class: in.etuwa.app.ui.attendance.bysubject.AttendanceViewModel$getAttendance$1
            ...
            public final void invoke2(AttendanceResponse attendanceResponse) {
                MutableLiveData mutableLiveData;
                mutableLiveData = AttendanceViewModel.this.attendanceResponse;
                mutableLiveData.postValue(Resource.INSTANCE.success(attendanceResponse));
            }
        };
        Consumer<? super AttendanceResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.attendance.bysubject.AttendanceViewModel$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                AttendanceViewModel.getAttendance$lambda$2(Function1.this, obj);
            }
        };
        ...
        compositeDisposable.add(observeOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.attendance.bysubject.AttendanceViewModel$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                AttendanceViewModel.getAttendance$lambda$3(Function1.this, obj);
            }
        }));
    }
