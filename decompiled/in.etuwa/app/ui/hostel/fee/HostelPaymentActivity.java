...
public final class HostelPaymentActivity extends AppCompatActivity {
    ...
    public HostelPaymentActivity() {
        final HostelPaymentActivity hostelPaymentActivity = this;
        LazyThreadSafetyMode lazyThreadSafetyMode = LazyThreadSafetyMode.SYNCHRONIZED;
        final Qualifier qualifier = null;
        final byte b = 0 == true ? 1 : 0;
        this.preference = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<SharedPrefManager>() { // from class: in.etuwa.app.ui.hostel.fee.HostelPaymentActivity$special$$inlined$inject$default$1
            ...
            public final SharedPrefManager invoke() {
                ComponentCallbacks componentCallbacks = hostelPaymentActivity;
