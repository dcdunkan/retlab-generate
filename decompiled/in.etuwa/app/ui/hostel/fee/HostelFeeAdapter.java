...
public final class HostelFeeAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public HostelFeeAdapter(Context context, ArrayList<HostelFeeBean> list) {
    ...
    public static final class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            this.name = (TextView) itemView.findViewById(R.id.hostRecycPayName);
            this.amount = (TextView) itemView.findViewById(R.id.hostRecycPayable);
            this.layout = (LinearLayout) itemView.findViewById(R.id.linearHost);
        }
