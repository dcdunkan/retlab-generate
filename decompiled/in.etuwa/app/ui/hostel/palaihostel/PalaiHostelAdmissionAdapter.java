...
/* JADX INFO: compiled from: PalaiHostelAdmissionAdapter.kt */
...
public final class PalaiHostelAdmissionAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View viewInflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_palai_hostel_new, parent, false);
            ...
            try {
                ...
                textView.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.hostel.palaihostel.PalaiHostelAdmissionAdapter$ViewHolder$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(View view) {
                        PalaiHostelAdmissionAdapter.ViewHolder.onBind$lambda$0(palaiHostelAdmissionAdapter, position, view);
                    }
                });
                ...
                checkBox.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.hostel.palaihostel.PalaiHostelAdmissionAdapter$ViewHolder$$ExternalSyntheticLambda1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        PalaiHostelAdmissionAdapter.ViewHolder.onBind$lambda$1(palaiHostelAdmissionAdapter2, position, this, hostelPalaiAdmission, view);
                    }
                });
