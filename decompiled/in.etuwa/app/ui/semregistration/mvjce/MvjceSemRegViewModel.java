...
/* JADX INFO: compiled from: MvjceSemRegViewModel.kt */
...
public final class MvjceSemRegViewModel extends ViewModel {
    ...
    public final void registerWithReceipt(HashMap<String, RequestBody> partMap, File file) {
        ...
        if (file != null) {
            ...
            observableSubscribeOn.subscribe(new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda13
                @Override // io.reactivex.functions.Consumer
                public final void accept(Object obj) {
                    MvjceSemRegViewModel.registerWithReceipt$lambda$0(function1, obj);
                }
            });
        } else {
        ...
        Consumer<? super SemRegSuccessResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MvjceSemRegViewModel.registerWithReceipt$lambda$1(function12, obj);
            }
        };
        ...
        compositeDisposable.add(observableObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda2
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MvjceSemRegViewModel.registerWithReceipt$lambda$2(function13, obj);
            }
        }));
    }
    ...
    public final void registerWithoutReceipt(Map<String, String> semesterRegistration) {
        ...
        Consumer<? super SemRegSuccessResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda6
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MvjceSemRegViewModel.registerWithoutReceipt$lambda$3(function1, obj);
            }
        };
        ...
        compositeDisposable.add(observableObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda7
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MvjceSemRegViewModel.registerWithoutReceipt$lambda$4(function12, obj);
            }
        }));
    }
    ...
    public final void registerWithReceipt(RequestBody id, HashMap<String, RequestBody> partMap, File file) {
        ...
        if (file != null) {
            ...
            observableSubscribeOn.subscribe(new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda10
                @Override // io.reactivex.functions.Consumer
                public final void accept(Object obj) {
                    MvjceSemRegViewModel.registerWithReceipt$lambda$5(function1, obj);
                }
            });
        } else {
            this.regResponse.postValue(Resource.INSTANCE.loading(null));
        ...
        Consumer<? super SemRegSuccessResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda11
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MvjceSemRegViewModel.registerWithReceipt$lambda$6(function12, obj);
            }
        };
        ...
        compositeDisposable.add(observableObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda12
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MvjceSemRegViewModel.registerWithReceipt$lambda$7(function13, obj);
            }
        }));
    }
    ...
    public final void registerWithoutReceipt(String id, Map<String, String> semesterRegistration) {
        ...
        Consumer<? super SemRegSuccessResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MvjceSemRegViewModel.registerWithoutReceipt$lambda$8(function1, obj);
            }
        };
        ...
        compositeDisposable.add(observableObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda5
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MvjceSemRegViewModel.registerWithoutReceipt$lambda$9(function12, obj);
            }
        }));
    }
    ...
    public final void getDropDowns() {
        ...
        Consumer<? super AcademicYearResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda8
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MvjceSemRegViewModel.getDropDowns$lambda$10(function1, obj);
            }
        };
        ...
        compositeDisposable.add(singleObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda9
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MvjceSemRegViewModel.getDropDowns$lambda$11(function12, obj);
            }
        }));
    }
    ...
    public final void getData(String id) {
        ...
        final Function1<SemRegViewResponse, Unit> function1 = new Function1<SemRegViewResponse, Unit>() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel.getData.1
            ...
            public final void invoke2(SemRegViewResponse semRegViewResponse) {
                MvjceSemRegViewModel.this.regviewResponse.postValue(Resource.INSTANCE.success(semRegViewResponse));
            }
        };
        Consumer<? super SemRegViewResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda3
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MvjceSemRegViewModel.getData$lambda$12(function1, obj);
            }
        };
        final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel.getData.2
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Throwable th) {
                MvjceSemRegViewModel.this.regviewResponse.postValue(Resource.INSTANCE.exception(AppConstant.ERROR_MSG));
            }
        };
        compositeDisposable.add(singleObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.semregistration.mvjce.MvjceSemRegViewModel$$ExternalSyntheticLambda4
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                MvjceSemRegViewModel.getData$lambda$13(function12, obj);
            }
        }));
    }
