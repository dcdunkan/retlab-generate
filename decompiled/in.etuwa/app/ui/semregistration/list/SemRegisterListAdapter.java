...
/* JADX INFO: compiled from: SemRegisterListAdapter.kt */
...
public final class SemRegisterListAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View viewInflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_sem_reg_list, parent, false);
            ...
            try {
                ...
                textView.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.semregistration.list.SemRegisterListAdapter$ViewHolder$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(View view) {
                        SemRegisterListAdapter.ViewHolder.onBind$lambda$0(semRegisterListAdapter, registerList, view);
                    }
                });
