...
/* JADX INFO: compiled from: ResultViewModel.kt */
...
public final class ResultViewModel extends ViewModel implements KoinComponent {
    ...
    public ResultViewModel(ResultRepository resultRepository) {
        ...
        this.preference = LazyKt.lazy(lazyThreadSafetyModeDefaultLazyMode, (Function0) new Function0<SharedPrefManager>() { // from class: in.etuwa.app.ui.result.ResultViewModel$special$$inlined$inject$default$1
            ...
            public final SharedPrefManager invoke() {
                Scope rootScope;
                KoinComponent koinComponent = resultViewModel;
    ...
    public final void getResult(String id) {
        ...
        final Function1<UnivResponse, Unit> function1 = new Function1<UnivResponse, Unit>() { // from class: in.etuwa.app.ui.result.ResultViewModel.getResult.1
            {
                super(1);
            }
            ...
            public final void invoke2(UnivResponse univResponse) {
                ResultViewModel.this.resultResponse.postValue(Resource.INSTANCE.success(univResponse));
            }
        };
        Consumer<? super UnivResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.result.ResultViewModel$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                ResultViewModel.getResult$lambda$0(function1, obj);
            }
        };
        final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: in.etuwa.app.ui.result.ResultViewModel.getResult.2
            {
                super(1);
            }
            ...
            public final void invoke2(Throwable th) {
                ResultViewModel.this.resultResponse.postValue(Resource.INSTANCE.exception(AppConstant.ERROR_MSG));
            }
        };
        compositeDisposable.add(singleObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.result.ResultViewModel$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                ResultViewModel.getResult$lambda$1(function12, obj);
            }
        }));
    }
