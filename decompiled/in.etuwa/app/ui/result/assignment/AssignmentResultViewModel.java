...
/* compiled from: AssignmentResultViewModel.kt */
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\"\u0010\u000f\u001a\u001e\u0012\u001a\u0012\u0018\u0012\u0014\u0012\u0012\u0012\u0004\u0012\u00020\u000b0\nj\b\u0012\u0004\u0012\u00020\u000b`\f0\t0\bJ\u000e\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u0013J\"\u0010\u0014\u001a\u001e\u0012\u001a\u0012\u0018\u0012\u0014\u0012\u0012\u0012\u0004\u0012\u00020\u000e0\nj\b\u0012\u0004\u0012\u00020\u000e`\f0\t0\bJ\u0006\u0010\u0015\u001a\u00020\u0011J\b\u0010\u0016\u001a\u00020\u0011H\u0014R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R*\u0010\u0007\u001a\u001e\u0012\u001a\u0012\u0018\u0012\u0014\u0012\u0012\u0012\u0004\u0012\u00020\u000b0\nj\b\u0012\u0004\u0012\u00020\u000b`\f0\t0\bX\u0082\u000e¢\u0006\u0002\n\u0000R*\u0010\r\u001a\u001e\u0012\u001a\u0012\u0018\u0012\u0014\u0012\u0012\u0012\u0004\u0012\u00020\u000e0\nj\b\u0012\u0004\u0012\u00020\u000e`\f0\t0\bX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0017"}, d2 = {"Lin/etuwa/app/ui/result/assignment/AssignmentResultViewModel;", "Landroidx/lifecycle/ViewModel;", "resultRepository", "Lin/etuwa/app/data/repository/ResultRepository;", "(Lin/etuwa/app/data/repository/ResultRepository;)V", "compositeDisposable", "Lio/reactivex/disposables/CompositeDisposable;", "resultResponse", "Landroidx/lifecycle/MutableLiveData;", "Lin/etuwa/app/utils/Resource;", "Ljava/util/ArrayList;", "Lin/etuwa/app/data/model/result/ResultAssignment;", "Lkotlin/collections/ArrayList;", "semResponse", "Lin/etuwa/app/data/model/Semester;", "getResponse", "getResult", "", "id", "", "getSemResponse", "getSemester", "onCleared", "app_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class AssignmentResultViewModel extends ViewModel {
    ...
    public final void getSemester() {
        ...
        final Function1<ArrayList<Semester>, Unit> function1 = new Function1<ArrayList<Semester>, Unit>() { // from class: in.etuwa.app.ui.result.assignment.AssignmentResultViewModel$getSemester$1
            {
                super(1);
            }
            ...
            public final void invoke2(ArrayList<Semester> arrayList) {
                ...
                mutableLiveData = AssignmentResultViewModel.this.semResponse;
                mutableLiveData.postValue(Resource.INSTANCE.success(arrayList));
            }
        };
        Consumer<? super ArrayList<Semester>> consumer = new Consumer() { // from class: in.etuwa.app.ui.result.assignment.AssignmentResultViewModel$$ExternalSyntheticLambda2
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                AssignmentResultViewModel.getSemester$lambda$0(Function1.this, obj);
            }
        };
        final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: in.etuwa.app.ui.result.assignment.AssignmentResultViewModel$getSemester$2
            {
                super(1);
            }
        ...
        compositeDisposable.add(observeOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.result.assignment.AssignmentResultViewModel$$ExternalSyntheticLambda3
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                AssignmentResultViewModel.getSemester$lambda$1(Function1.this, obj);
            }
        }));
    }
    ...
    public final void getResult(String id) {
        ...
        CompositeDisposable compositeDisposable = this.compositeDisposable;
        Single<ArrayList<ResultAssignment>> observeOn = this.resultRepository.getResultAssignmentApiCall(new AttendanceRequest(id)).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
        final Function1<ArrayList<ResultAssignment>, Unit> function1 = new Function1<ArrayList<ResultAssignment>, Unit>() { // from class: in.etuwa.app.ui.result.assignment.AssignmentResultViewModel$getResult$1
            ...
            public final void invoke2(ArrayList<ResultAssignment> arrayList) {
                MutableLiveData mutableLiveData;
                mutableLiveData = AssignmentResultViewModel.this.resultResponse;
                mutableLiveData.postValue(Resource.INSTANCE.success(arrayList));
            }
        };
        Consumer<? super ArrayList<ResultAssignment>> consumer = new Consumer() { // from class: in.etuwa.app.ui.result.assignment.AssignmentResultViewModel$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                AssignmentResultViewModel.getResult$lambda$2(Function1.this, obj);
            }
        };
        ...
        compositeDisposable.add(observeOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.result.assignment.AssignmentResultViewModel$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                AssignmentResultViewModel.getResult$lambda$3(Function1.this, obj);
            }
        }));
    }
