...
/* JADX INFO: compiled from: ResultModuleTestViewModel.kt */
...
public final class ResultModuleTestViewModel extends ViewModel {
    ...
    public final void getSemester(Context context) {
        ...
        if (string != null) {
            Object objFromJson = new Gson().fromJson(string, new TypeToken<ArrayList<Semester>>() { // from class: in.etuwa.app.ui.result.moduletest.ResultModuleTestViewModel$getSemester$type$1
            }.getType());
    ...
    public final void getResult(String id) {
        ...
        Single<ResultModuleTestResponse> singleObserveOn = this.resultRepository.getResultModuleTestApiCall(new AttendanceRequest(id)).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
        final Function1<ResultModuleTestResponse, Unit> function1 = new Function1<ResultModuleTestResponse, Unit>() { // from class: in.etuwa.app.ui.result.moduletest.ResultModuleTestViewModel.getResult.1
            ...
            public final void invoke2(ResultModuleTestResponse resultModuleTestResponse) {
                ResultModuleTestViewModel.this.resultResponse.postValue(Resource.INSTANCE.success(resultModuleTestResponse));
            }
        };
        Consumer<? super ResultModuleTestResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.result.moduletest.ResultModuleTestViewModel$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                ResultModuleTestViewModel.getResult$lambda$0(function1, obj);
            }
        };
        final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: in.etuwa.app.ui.result.moduletest.ResultModuleTestViewModel.getResult.2
            ...
            public final void invoke2(Throwable th) {
                ResultModuleTestViewModel.this.resultResponse.postValue(Resource.INSTANCE.exception(AppConstant.ERROR_MSG));
            }
        };
        compositeDisposable.add(singleObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.result.moduletest.ResultModuleTestViewModel$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                ResultModuleTestViewModel.getResult$lambda$1(function12, obj);
            }
        }));
    }
