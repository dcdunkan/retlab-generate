...
/* JADX INFO: compiled from: TutorialResultAdapter.kt */
...
public final class TutorialResultAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View viewInflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_tutorial_result, parent, false);
