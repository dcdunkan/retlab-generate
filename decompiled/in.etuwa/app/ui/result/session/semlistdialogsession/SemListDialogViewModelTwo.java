...
/* JADX INFO: compiled from: SemListDialogViewModelTwo.kt */
...
public final class SemListDialogViewModelTwo extends ViewModel {
    ...
    public final void getSemester(Context context) {
        ...
        if (string != null) {
            Object objFromJson = new Gson().fromJson(string, new TypeToken<ArrayList<Semester>>() { // from class: in.etuwa.app.ui.result.session.semlistdialogsession.SemListDialogViewModelTwo$getSemester$type$1
            }.getType());
