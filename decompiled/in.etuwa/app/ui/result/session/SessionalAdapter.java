...
public final class SessionalAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public final class ViewHolder extends BaseViewHolder {
        ...
        final /* synthetic */ SessionalAdapter this$0;
        ...
        public ViewHolder(SessionalAdapter sessionalAdapter, View itemView) {
            super(itemView);
            Intrinsics.checkNotNullParameter(itemView, "itemView");
            this.this$0 = sessionalAdapter;
            this.subject = (TextView) itemView.findViewById(R.id.result_session_subject);
            this.score = (TextView) itemView.findViewById(R.id.result_session_score);
        }
        ...
        public void onBind(int position) {
            ...
            try {
                ...
                this.score.setText(resultSeasonal.getObtainMark() + " / " + resultSeasonal.getMaxMark());
    ...
    public final void addItems(ArrayList<ResultSeasonal> list) {
