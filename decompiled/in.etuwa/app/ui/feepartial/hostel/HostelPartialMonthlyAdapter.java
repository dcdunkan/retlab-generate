...
/* JADX INFO: compiled from: HostelPartialMonthlyAdapter.kt */
...
public final class HostelPartialMonthlyAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View viewInflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_palai_hostel, parent, false);
            ...
            try {
                ...
                textView.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.feepartial.hostel.HostelPartialMonthlyAdapter$ViewHolder$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(View view) {
                        HostelPartialMonthlyAdapter.ViewHolder.onBind$lambda$0(hostelPartialMonthlyAdapter, position, view);
                    }
                });
                ...
                checkBox.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.feepartial.hostel.HostelPartialMonthlyAdapter$ViewHolder$$ExternalSyntheticLambda1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        HostelPartialMonthlyAdapter.ViewHolder.onBind$lambda$1(hostelPartialMonthlyAdapter2, position, this, hostelMonth, view);
                    }
                });
