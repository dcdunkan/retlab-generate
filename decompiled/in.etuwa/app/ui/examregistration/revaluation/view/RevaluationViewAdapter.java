...
/* JADX INFO: compiled from: RevaluationViewAdapter.kt */
...
public final class RevaluationViewAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View viewInflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_revaluation_view, parent, false);
                ...
                if (textView != null) {
                    ...
                    textView.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.examregistration.revaluation.view.RevaluationViewAdapter$ViewHolder$$ExternalSyntheticLambda0
                        ...
                        public final void onClick(View view) {
                            RevaluationViewAdapter.ViewHolder.onBind$lambda$0(revaluationViewAdapter, revaluationView, view);
                        }
                    });
                }
