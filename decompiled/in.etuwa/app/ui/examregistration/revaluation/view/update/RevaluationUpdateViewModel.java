...
/* compiled from: RevaluationUpdateViewModel.kt */
@Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u000e\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000eJ\u0012\u0010\u000f\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\n0\t0\bJ\b\u0010\u0010\u001a\u00020\fH\u0014R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\u0007\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\n0\t0\bX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0011"}, d2 = {"Lin/etuwa/app/ui/examregistration/revaluation/view/update/RevaluationUpdateViewModel;", "Landroidx/lifecycle/ViewModel;", "examRegistrationRepository", "Lin/etuwa/app/data/repository/ExamRegistrationRepository;", "(Lin/etuwa/app/data/repository/ExamRegistrationRepository;)V", "compositeDisposable", "Lio/reactivex/disposables/CompositeDisposable;", "revaluationResponse", "Landroidx/lifecycle/MutableLiveData;", "Lin/etuwa/app/utils/Resource;", "Lin/etuwa/app/data/model/examregister/RevaluationUpdateResponse;", "getExamData", "", "id", "", "getResponse", "onCleared", "app_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class RevaluationUpdateViewModel extends ViewModel {
    ...
    public final void getExamData(String id) {
        ...
        Single<RevaluationUpdateResponse> observeOn = this.examRegistrationRepository.getExamRevaluationUpdateApiCall(id).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
        final Function1<RevaluationUpdateResponse, Unit> function1 = new Function1<RevaluationUpdateResponse, Unit>() { // from class: in.etuwa.app.ui.examregistration.revaluation.view.update.RevaluationUpdateViewModel$getExamData$1
            ...
            public final void invoke2(RevaluationUpdateResponse revaluationUpdateResponse) {
                ...
                mutableLiveData = RevaluationUpdateViewModel.this.revaluationResponse;
                mutableLiveData.postValue(Resource.INSTANCE.success(revaluationUpdateResponse));
            }
        };
        Consumer<? super RevaluationUpdateResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.examregistration.revaluation.view.update.RevaluationUpdateViewModel$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj) {
                RevaluationUpdateViewModel.getExamData$lambda$0(Function1.this, obj);
            }
        };
        ...
        compositeDisposable.add(observeOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.examregistration.revaluation.view.update.RevaluationUpdateViewModel$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                RevaluationUpdateViewModel.getExamData$lambda$1(Function1.this, obj);
            }
        }));
    }
