...
/* JADX INFO: compiled from: ExamSubjectAdapter2.kt */
...
public final class ExamSubjectAdapter2 extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View viewInflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_exam_subject2, parent, false);
    ...
    public final class ViewHolder extends BaseViewHolder {
        ...
        private final MaterialButton viewRegisterBtn;
        ...
        public ViewHolder(ExamSubjectAdapter2 examSubjectAdapter2, View itemView) {
            ...
            this.viewRegisterBtn = (MaterialButton) itemView.findViewById(R.id.view_register_btn);
            this.viewBtn = (MaterialButton) itemView.findViewById(R.id.view_btn);
        }
        ...
        public void onBind(int position) {
            ...
            try {
                ...
                MaterialButton materialButton = this.viewRegisterBtn;
                if (materialButton != null) {
                    materialButton.setText("View Result");
                }
                MaterialButton materialButton2 = this.viewBtn;
                if (materialButton2 != null) {
                    materialButton2.setVisibility(4);
                }
                MaterialButton materialButton3 = this.viewRegisterBtn;
                if (materialButton3 != null) {
                    final ExamSubjectAdapter2 examSubjectAdapter2 = this.this$0;
                    materialButton3.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.examregistration.examsubjects.ExamSubjectAdapter2$ViewHolder$$ExternalSyntheticLambda0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            ExamSubjectAdapter2.ViewHolder.onBind$lambda$0(examSubjectAdapter2, examRegister, view);
                        }
                    });
                }
