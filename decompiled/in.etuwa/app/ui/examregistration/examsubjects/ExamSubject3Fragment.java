...
public final class ExamSubject3Fragment extends BaseFragment implements ExamSubjectAdapter.CallBack, ExamSubjectDetailDialog.ExamDetailListner, ExamSubjectAdapter2.CallBack, ExamSubjectAdapter3.CallBack {
    ...
    @JvmStatic
    public static final ExamSubject3Fragment newInstance(String str) {
    ...
    public ExamSubject3Fragment() {
        final ExamSubject3Fragment examSubject3Fragment = this;
        final Function0<Fragment> function0 = new Function0<Fragment>() { // from class: in.etuwa.app.ui.examregistration.examsubjects.ExamSubject3Fragment$special$$inlined$viewModel$default$1
            {
                super(0);
            }
        ...
        final Scope koinScope = AndroidKoinScopeExtKt.getKoinScope(examSubject3Fragment);
        final Qualifier qualifier = null;
        final byte b = 0 == true ? 1 : 0;
        this.examSubjectViewModel = FragmentViewModelLazyKt.createViewModelLazy(examSubject3Fragment, Reflection.getOrCreateKotlinClass(ExamSubjectViewModel.class), new Function0<ViewModelStore>() { // from class: in.etuwa.app.ui.examregistration.examsubjects.ExamSubject3Fragment$special$$inlined$viewModel$default$3
            {
                super(0);
            }
        ...
        }, new Function0<ViewModelProvider.Factory>() { // from class: in.etuwa.app.ui.examregistration.examsubjects.ExamSubject3Fragment$special$$inlined$viewModel$default$2
        ...
        final ExamSubject3Fragment examSubject3Fragment2 = this;
        LazyThreadSafetyMode lazyThreadSafetyMode = LazyThreadSafetyMode.SYNCHRONIZED;
        final byte b2 = 0 == true ? 1 : 0;
        final byte b3 = 0 == true ? 1 : 0;
        this.adapter3 = LazyKt.lazy(lazyThreadSafetyMode, (Function0) new Function0<ExamSubjectAdapter3>() { // from class: in.etuwa.app.ui.examregistration.examsubjects.ExamSubject3Fragment$special$$inlined$inject$default$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
            ...
            public final ExamSubjectAdapter3 invoke() {
                ComponentCallbacks componentCallbacks = examSubject3Fragment2;
                return AndroidKoinScopeExtKt.getKoinScope(componentCallbacks).get(Reflection.getOrCreateKotlinClass(ExamSubjectAdapter3.class), b2, b3);
            }
        });
    }
    ...
    /* compiled from: ExamSubject3Fragment.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007¨\u0006\u0007"}, d2 = {"Lin/etuwa/app/ui/examregistration/examsubjects/ExamSubject3Fragment$Companion;", "", "()V", "newInstance", "Lin/etuwa/app/ui/examregistration/examsubjects/ExamSubject3Fragment;", "flag", "", "app_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class Companion {
        ...
        @JvmStatic
        public final ExamSubject3Fragment newInstance(String flag) {
            Intrinsics.checkNotNullParameter(flag, "flag");
            ExamSubject3Fragment examSubject3Fragment = new ExamSubject3Fragment();
            Bundle bundle = new Bundle();
            bundle.putString("id", flag);
            examSubject3Fragment.setArguments(bundle);
            return examSubject3Fragment;
        }
    }
    ...
    protected void setUp() {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: in.etuwa.app.ui.examregistration.examsubjects.ExamSubject3Fragment$$ExternalSyntheticLambda0
            @Override // androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener
            public final void onRefresh() {
                ExamSubject3Fragment.setUp$lambda$1(ExamSubject3Fragment.this);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setUp$lambda$1(ExamSubject3Fragment this$0) {
    ...
    private final void listenResponse() {
        getExamSubjectViewModel().getResponse().observe(getViewLifecycleOwner(), new Observer() { // from class: in.etuwa.app.ui.examregistration.examsubjects.ExamSubject3Fragment$$ExternalSyntheticLambda2
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                ExamSubject3Fragment.listenResponse$lambda$3(ExamSubject3Fragment.this, (Resource) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void listenResponse$lambda$3(ExamSubject3Fragment this$0, Resource resource) {
    ...
    private final void listenStatusResponse() {
        getExamSubjectViewModel().getStatusResponse().observe(getViewLifecycleOwner(), new Observer() { // from class: in.etuwa.app.ui.examregistration.examsubjects.ExamSubject3Fragment$$ExternalSyntheticLambda1
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                ExamSubject3Fragment.listenStatusResponse$lambda$5(ExamSubject3Fragment.this, (Resource) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void listenStatusResponse$lambda$5(ExamSubject3Fragment this$0, Resource resource) {
        RecyclerView recyclerView;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        int i = WhenMappings.$EnumSwitchMapping$0[resource.getStatus().ordinal()];
        if (i != 1) {
