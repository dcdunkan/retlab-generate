...
/* JADX INFO: compiled from: ExamReceiptAdapter.kt */
...
public final class ExamReceiptAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View viewInflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_exam_receipt, parent, false);
                ...
                if (textView != null) {
                    ...
                    textView.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.examregistration.examreceipt.ExamReceiptAdapter$ViewHolder$$ExternalSyntheticLambda0
                        ...
                        public final void onClick(View view) {
                            ExamReceiptAdapter.ViewHolder.onBind$lambda$0(examReceiptAdapter, examReceipt, view);
                        }
                    });
                }
