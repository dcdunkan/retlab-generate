...
/* JADX INFO: compiled from: OnlineClassAdapter.kt */
...
public final class OnlineClassAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View viewInflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_online_class, parent, false);
            ...
            try {
                ...
                textView.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.onlineclass.OnlineClassAdapter$ViewHolder$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(View view) {
                        OnlineClassAdapter.ViewHolder.onBind$lambda$0(onlineClass, onlineClassAdapter, this, view);
                    }
                });
