...
/* JADX INFO: compiled from: FeesMainEngineerAdapter.kt */
/* JADX INFO: loaded from: classes4.dex */
public final class FeesMainEngineerAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    private Context context;
    private CallBack listener;
    private double total;
    private final ArrayList<FeeEngineer> list = new ArrayList<>();
    private List<String> selected = new ArrayList();
    private List<String> selectedTotal = new ArrayList();
    private List<String> deatilPosition = new ArrayList();

    /* JADX INFO: compiled from: FeesMainEngineerAdapter.kt */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010!\n\u0002\u0010\u000e\n\u0002\b\u0002\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&J$\u0010\u0006\u001a\u00020\u00032\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\b2\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\t0\bH&¨\u0006\u000b"}, d2 = {"Lin/etuwa/app/ui/fees/FeesMainEngineerAdapter$CallBack;", "", "selectedIds", "", CommonCssConstants.POSITION, "", "updateSelected", "sel", "", "", FeeConfirmDialogKt.ARG_TOTAL, "app_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    /* JADX INFO: compiled from: FeesMainEngineerAdapter.kt */
    @Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0004\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\r\u001a\u00020\u000eH\u0014J\u0010\u0010\u000f\u001a\u00020\u000e2\u0006\u0010\u0010\u001a\u00020\u0011H\u0016R\u0016\u0010\u0005\u001a\n \u0007*\u0004\u0018\u00010\u00060\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\b\u001a\n \u0007*\u0004\u0018\u00010\t0\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\n\u001a\n \u0007*\u0004\u0018\u00010\t0\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000b\u001a\n \u0007*\u0004\u0018\u00010\t0\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\f\u001a\n \u0007*\u0004\u0018\u00010\t0\tX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0012"}, d2 = {"Lin/etuwa/app/ui/fees/FeesMainEngineerAdapter$ViewHolder;", "Lin/etuwa/app/ui/base/BaseViewHolder;", "itemView", "Landroid/view/View;", "(Lin/etuwa/app/ui/fees/FeesMainEngineerAdapter;Landroid/view/View;)V", "checkBox", "Landroid/widget/CheckBox;", "kotlin.jvm.PlatformType", "detailBtn", "Landroid/widget/TextView;", "feeAmount", "feeBalance", "feeHead", "clear", "", "onBind", CommonCssConstants.POSITION, "", "app_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public final class ViewHolder extends BaseViewHolder {
        ...
        final /* synthetic */ FeesMainEngineerAdapter this$0;
        ...
        public ViewHolder(FeesMainEngineerAdapter feesMainEngineerAdapter, View itemView) {
            super(itemView);
            Intrinsics.checkNotNullParameter(itemView, "itemView");
            this.this$0 = feesMainEngineerAdapter;
        ...
        public void onBind(final int position) {
            ...
            try {
                ...
                FeeEngineer feeEngineer = (FeeEngineer) obj;
                this.feeHead.setText(feeEngineer.getInstallment_name());
                ...
                int i = 0;
                if (feeEngineer.getInstallments().size() == 0) {
                ...
                if (size >= 0) {
                    ...
                    while (true) {
                        ...
                        Double.parseDouble(feeEngineer.getInstallments().get(i).getPaid());
                        Double.parseDouble(feeEngineer.getInstallments().get(i).getScholarship());
                        Double.parseDouble(feeEngineer.getInstallments().get(i).getDiscount());
                        if (i == size) {
                            break;
                        } else {
                            i++;
                ...
                final FeesMainEngineerAdapter feesMainEngineerAdapter = this.this$0;
                checkBox.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.fees.FeesMainEngineerAdapter$ViewHolder$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        FeesMainEngineerAdapter.ViewHolder.onBind$lambda$0(this.f$0, doubleRef, feesMainEngineerAdapter, position, view);
                    }
                });
                TextView textView = this.detailBtn;
                final FeesMainEngineerAdapter feesMainEngineerAdapter2 = this.this$0;
                textView.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.fees.FeesMainEngineerAdapter$ViewHolder$$ExternalSyntheticLambda1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        FeesMainEngineerAdapter.ViewHolder.onBind$lambda$1(feesMainEngineerAdapter2, position, view);
                    }
                });
        ...
        public static final void onBind$lambda$0(ViewHolder this$0, Ref.DoubleRef balance, FeesMainEngineerAdapter this$1, int i, View view) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final void onBind$lambda$1(FeesMainEngineerAdapter this$0, int i, View view) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
