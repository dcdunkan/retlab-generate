...
/* JADX INFO: compiled from: SeriesExamViewModel.kt */
...
public final class SeriesExamViewModel extends ViewModel {
    ...
    public final void getSemester() {
        ...
        Single<ArrayList<Semester>> singleObserveOn = this.examRepository.getSemestersApiCall().subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
        final Function1<ArrayList<Semester>, Unit> function1 = new Function1<ArrayList<Semester>, Unit>() { // from class: in.etuwa.app.ui.exam.series.SeriesExamViewModel.getSemester.1
            ...
            public final void invoke2(ArrayList<Semester> arrayList) {
                SeriesExamViewModel.this.semResponse.postValue(Resource.INSTANCE.success(arrayList));
            }
        };
        Consumer<? super ArrayList<Semester>> consumer = new Consumer() { // from class: in.etuwa.app.ui.exam.series.SeriesExamViewModel$$ExternalSyntheticLambda2
            ...
            public final void accept(Object obj) {
                SeriesExamViewModel.getSemester$lambda$0(function1, obj);
            }
        };
        final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: in.etuwa.app.ui.exam.series.SeriesExamViewModel.getSemester.2
            ...
            public final void invoke2(Throwable th) {
                SeriesExamViewModel.this.semResponse.postValue(Resource.INSTANCE.exception(AppConstant.ERROR_MSG));
            }
        };
        compositeDisposable.add(singleObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.exam.series.SeriesExamViewModel$$ExternalSyntheticLambda3
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                SeriesExamViewModel.getSemester$lambda$1(function12, obj);
            }
        }));
    }
    ...
    public final void getExams(String id) {
        ...
        CompositeDisposable compositeDisposable = this.compositeDisposable;
        Single<SeriesExamResponse> singleObserveOn = this.examRepository.getSeriesExamApiCall(new AttendanceRequest(id)).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
        final Function1<SeriesExamResponse, Unit> function1 = new Function1<SeriesExamResponse, Unit>() { // from class: in.etuwa.app.ui.exam.series.SeriesExamViewModel.getExams.1
            ...
            public final void invoke2(SeriesExamResponse seriesExamResponse) {
                SeriesExamViewModel.this.examResponse.postValue(Resource.INSTANCE.success(seriesExamResponse));
            }
        };
        Consumer<? super SeriesExamResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.exam.series.SeriesExamViewModel$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                SeriesExamViewModel.getExams$lambda$2(function1, obj);
            }
        };
        final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: in.etuwa.app.ui.exam.series.SeriesExamViewModel.getExams.2
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Throwable th) {
                SeriesExamViewModel.this.examResponse.postValue(Resource.INSTANCE.exception(AppConstant.ERROR_MSG));
            }
        };
        compositeDisposable.add(singleObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.exam.series.SeriesExamViewModel$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                SeriesExamViewModel.getExams$lambda$3(function12, obj);
            }
        }));
    }
    ...
    public final void deleteExam(String id) {
        ...
        CompositeDisposable compositeDisposable = this.compositeDisposable;
        Single<SuccessResponse> singleObserveOn = this.examRepository.deleteSeriesExamApiCall(id).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
        ...
        Consumer<? super SuccessResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.exam.series.SeriesExamViewModel$$ExternalSyntheticLambda4
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                SeriesExamViewModel.deleteExam$lambda$4(function1, obj);
            }
        };
        ...
        compositeDisposable.add(singleObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.exam.series.SeriesExamViewModel$$ExternalSyntheticLambda5
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                SeriesExamViewModel.deleteExam$lambda$5(function12, obj);
            }
        }));
    }
