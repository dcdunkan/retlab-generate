...
/* JADX INFO: compiled from: EvaluationSeriesAdapter.kt */
/* JADX INFO: loaded from: classes4.dex */
public final class EvaluationSeriesAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    /* JADX INFO: compiled from: EvaluationSeriesAdapter.kt */
    @Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\n\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0004\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\b\u0010\u0010\u001a\u00020\u0011H\u0014J\u0010\u0010\u0012\u001a\u00020\u00112\u0006\u0010\u0013\u001a\u00020\u0014H\u0016R\u0016\u0010\u0005\u001a\n \u0007*\u0004\u0018\u00010\u00060\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\b\u001a\n \u0007*\u0004\u0018\u00010\u00060\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\t\u001a\n \u0007*\u0004\u0018\u00010\u00060\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\n\u001a\n \u0007*\u0004\u0018\u00010\u00060\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000b\u001a\n \u0007*\u0004\u0018\u00010\u00060\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\f\u001a\n \u0007*\u0004\u0018\u00010\u00060\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\r\u001a\n \u0007*\u0004\u0018\u00010\u00030\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000e\u001a\n \u0007*\u0004\u0018\u00010\u00060\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000f\u001a\n \u0007*\u0004\u0018\u00010\u00060\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0015"}, d2 = {"Lin/etuwa/app/ui/exam/series/EvaluationSeriesAdapter$ViewHolder;", "Lin/etuwa/app/ui/base/BaseViewHolder;", "itemView", "Landroid/view/View;", "(Lin/etuwa/app/ui/exam/series/EvaluationSeriesAdapter;Landroid/view/View;)V", "deleteBtn", "Landroid/widget/TextView;", "kotlin.jvm.PlatformType", "dwnBtn", "issueDate", "lastDate", AttendanceDayDialogKt.ARG_SEM, "sub", "submittedView", "title", "upBtn", "clear", "", "onBind", CommonCssConstants.POSITION, "", "app_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public final class ViewHolder extends BaseViewHolder {
        ...
        final /* synthetic */ EvaluationSeriesAdapter this$0;
        ...
        public ViewHolder(EvaluationSeriesAdapter evaluationSeriesAdapter, View itemView) {
            super(itemView);
            Intrinsics.checkNotNullParameter(itemView, "itemView");
            this.this$0 = evaluationSeriesAdapter;
        ...
        public void onBind(final int position) {
            ...
            try {
                Object obj = this.this$0.filteredExams.get(position);
                Intrinsics.checkNotNullExpressionValue(obj, "filteredExams[position]");
                final Exam exam = (Exam) obj;
                TextView textView = this.sub;
                boolean z = true;
                String str2 = (String) CollectionsKt.getOrNull(StringsKt.split$default((CharSequence) exam.getSubject(), new String[]{HelpFormatter.DEFAULT_OPT_PREFIX}, false, 0, 6, (Object) null), 1);
                ...
                this.issueDate.setText("Start: " + this.this$0.orShort(exam.getStartTime(), HelpFormatter.DEFAULT_LONG_OPT_PREFIX));
                this.lastDate.setText("End: " + this.this$0.orShort(exam.getFinishTime(), HelpFormatter.DEFAULT_LONG_OPT_PREFIX));
                ...
                this.dwnBtn.setVisibility(exam.getFiles().isEmpty() ? 8 : 0);
                this.upBtn.setVisibility(exam.getCanSubmit() ? 0 : 8);
                if (exam.isDelete() && exam.getCanSubmit() && Intrinsics.areEqual(exam.getStatus(), "SUBMITTED")) {
                    this.deleteBtn.setVisibility(0);
                } else {
                    this.deleteBtn.setVisibility(8);
                }
                TextView textView2 = this.deleteBtn;
                final EvaluationSeriesAdapter evaluationSeriesAdapter = this.this$0;
                textView2.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.exam.series.EvaluationSeriesAdapter$ViewHolder$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        EvaluationSeriesAdapter.ViewHolder.onBind$lambda$0(evaluationSeriesAdapter, exam, view);
                    }
                });
                TextView textView3 = this.dwnBtn;
                final EvaluationSeriesAdapter evaluationSeriesAdapter2 = this.this$0;
                textView3.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.exam.series.EvaluationSeriesAdapter$ViewHolder$$ExternalSyntheticLambda1
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        EvaluationSeriesAdapter.ViewHolder.onBind$lambda$1(exam, evaluationSeriesAdapter2, this, view);
                    }
                });
                ...
                if (Intrinsics.areEqual(exam.getStatus(), "SUBMITTED")) {
                    ...
                    if (examListener == null || !examListener.checkFileExistence(strReplace)) {
                        z = false;
                    }
                ...
                final EvaluationSeriesAdapter evaluationSeriesAdapter3 = this.this$0;
                textView5.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.exam.series.EvaluationSeriesAdapter$ViewHolder$$ExternalSyntheticLambda2
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        EvaluationSeriesAdapter.ViewHolder.onBind$lambda$2(exam, evaluationSeriesAdapter3, this, position, view);
                    }
                });
            } catch (Exception e) {
                e.printStackTrace();
        ...
        public static final void onBind$lambda$0(EvaluationSeriesAdapter this$0, Exam exam, View view) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final void onBind$lambda$1(Exam exam, EvaluationSeriesAdapter this$0, ViewHolder this$1, View view) {
            Intrinsics.checkNotNullParameter(exam, "$exam");
            Intrinsics.checkNotNullParameter(this$0, "this$0");
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final void onBind$lambda$2(Exam exam, EvaluationSeriesAdapter this$0, ViewHolder this$1, int i, View view) {
            Intrinsics.checkNotNullParameter(exam, "$exam");
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            Intrinsics.checkNotNullParameter(this$1, "this$1");
    ...
    */
    public final void applyCombinedFilter(java.lang.String r11, java.lang.String r12) {
        ...
        Lb4:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: in.etuwa.app.ui.exam.series.EvaluationSeriesAdapter.applyCombinedFilter(java.lang.String, java.lang.String):void");
    }
    ...
    public static /* synthetic */ String orShort$default(EvaluationSeriesAdapter evaluationSeriesAdapter, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            str2 = HelpFormatter.DEFAULT_LONG_OPT_PREFIX;
        }
        return evaluationSeriesAdapter.orShort(str, str2);
    }
