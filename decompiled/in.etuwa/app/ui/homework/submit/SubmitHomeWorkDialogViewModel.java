...
/* JADX INFO: compiled from: SubmitHomeWorkDialogViewModel.kt */
...
public final class SubmitHomeWorkDialogViewModel extends ViewModel {
    ...
    public final void submitHomework(String _id, File filePath) {
        ...
        MultipartBody.Part partCreateFormData = MultipartBody.Part.INSTANCE.createFormData("HomeworkData[file_name]", filePath.getName(), progressRequestBody);
        ...
        observableSubscribeOn.subscribe(new Consumer() { // from class: in.etuwa.app.ui.homework.submit.SubmitHomeWorkDialogViewModel$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                SubmitHomeWorkDialogViewModel.submitHomework$lambda$0(function1, obj);
            }
        });
        CompositeDisposable compositeDisposable = this.compositeDisposable;
        Observable<SuccessResponse> observableObserveOn = this.homeWorkRepository.submitHomeWorkApiCall(requestBodyCreate, partCreateFormData).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
        ...
        Consumer<? super SuccessResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.homework.submit.SubmitHomeWorkDialogViewModel$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                SubmitHomeWorkDialogViewModel.submitHomework$lambda$1(function12, obj);
            }
        };
        ...
        compositeDisposable.add(observableObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.homework.submit.SubmitHomeWorkDialogViewModel$$ExternalSyntheticLambda2
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                SubmitHomeWorkDialogViewModel.submitHomework$lambda$2(function13, obj);
            }
        }));
    }
