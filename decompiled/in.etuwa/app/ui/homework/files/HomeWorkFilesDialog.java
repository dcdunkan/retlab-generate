...
public final class HomeWorkFilesDialog extends BaseDialog implements HomeWorkFilesAdapter.DocListener {
    ...
    /* JADX INFO: renamed from: homeWorkFilesDialogViewModel$delegate, reason: from kotlin metadata */
    ...
    public HomeWorkFilesDialog() {
        ...
        this.homeWorkFilesDialogViewModel = FragmentViewModelLazyKt.createViewModelLazy(homeWorkFilesDialog, Reflection.getOrCreateKotlinClass(HomeWorkFilesDialogViewModel.class), new Function0<ViewModelStore>() { // from class: in.etuwa.app.ui.homework.files.HomeWorkFilesDialog$special$$inlined$viewModel$default$3
            ...
            public final ViewModelProvider.Factory invoke() {
                return GetViewModelFactoryKt.getViewModelFactory((ViewModelStoreOwner) function0.invoke(), Reflection.getOrCreateKotlinClass(HomeWorkFilesDialogViewModel.class), qualifier, b, null, koinScope);
            }
        });
        ...
        this.onDownloadComplete = new BroadcastReceiver() { // from class: in.etuwa.app.ui.homework.files.HomeWorkFilesDialog$onDownloadComplete$1
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                try {
                    ...
                    HomeWorkFilesDialog homeWorkFilesDialog3 = this.this$0;
                    int i = 0;
                    for (Object obj : arrayList) {
                        ...
                        if (downloadModel.getId() == longExtra) {
                            homeWorkFilesDialog3.getAdapter().notifyDataChanged(((DownloadModel) homeWorkFilesDialog3.downList.get(i)).getPosition());
                            homeWorkFilesDialog3.downList.remove(new DownloadModel(downloadModel.getId(), i));
                        }
                        i = i2;
                    }
    ...
    public void downloadFile(String url, int position) {
        ...
        if (new ValidChecker(contextRequireContext).checkPermission() || Build.VERSION.SDK_INT >= 33) {
            if (checkFileExistence(strReplace)) {
                ...
                new DownloadManagerHelper(contextRequireContext2).openFile(strReplace, AppConstant.HOME_WORK_PATH);
                return;
            }
            try {
                HomeWorkFilesDialogBinding homeWorkFilesDialogBinding = get_binding();
                ...
                long jStartDownloading = new DownloadManagerHelper(contextRequireContext3).startDownloading(AppConstant.HOME_WORK_PATH, url);
    ...
    public boolean checkFileExistence(String fileName) {
        ...
        Context contextRequireContext = requireContext();
        Intrinsics.checkNotNullExpressionValue(contextRequireContext, "requireContext()");
        return new ValidChecker(contextRequireContext).checkFileExistence(fileName, AppConstant.HOME_WORK_PATH);
    }
