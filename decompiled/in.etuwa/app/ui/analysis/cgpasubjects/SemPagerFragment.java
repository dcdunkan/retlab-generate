...
/* JADX INFO: compiled from: SemPagerFragment.kt */
...
public final class SemPagerFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        try {
            ...
            ArrayList<AnalysisSubjectBean> arrayList = this.list;
            if (arrayList == null) {
            ...
            axisLeft.setValueFormatter(new ValueFormatter() { // from class: in.etuwa.app.ui.analysis.cgpasubjects.SemPagerFragment$onViewCreated$1$1
            ...
            ArrayList<AnalysisSubjectBean> arrayList3 = this.list;
            Intrinsics.checkNotNull(arrayList3);
            int size = arrayList3.size();
            for (int i = 0; i < size; i++) {
                ArrayList<AnalysisSubjectBean> arrayList4 = this.list;
                ...
                ArrayList<AnalysisSubjectBean> arrayList5 = this.list;
    ...
    private final ArrayList<IBarDataSet> getBarData(ArrayList<AnalysisSubjectBean> list) {
        ...
        barDataSet.setValueFormatter(new ValueFormatter() { // from class: in.etuwa.app.ui.analysis.cgpasubjects.SemPagerFragment$getBarData$dataSet$1$1
            @Override // com.github.mikephil.charting.formatter.ValueFormatter
