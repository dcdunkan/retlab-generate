...
/* JADX INFO: compiled from: HostelNewReceiptAdapter.kt */
...
public final class HostelNewReceiptAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View viewInflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_hostel_receipt, parent, false);
            ...
            try {
                ...
                textView.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.hostelnew.HostelNewReceiptAdapter$ViewHolder$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(View view) {
                        HostelNewReceiptAdapter.ViewHolder.onBind$lambda$0(hostelNewReceiptAdapter, hostelReceipt, view);
                    }
                });
