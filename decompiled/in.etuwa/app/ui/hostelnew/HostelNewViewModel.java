...
/* JADX INFO: compiled from: HostelNewViewModel.kt */
...
public final class HostelNewViewModel extends ViewModel {
    ...
    public final void getHostelAdmissionFee() {
        ...
        final Function1<HostelNewAdmissionResponse, Unit> function1 = new Function1<HostelNewAdmissionResponse, Unit>() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel.getHostelAdmissionFee.1
            ...
            public final void invoke2(HostelNewAdmissionResponse hostelNewAdmissionResponse) {
                HostelNewViewModel.this.hostelAdmissionResponse.postValue(Resource.INSTANCE.success(hostelNewAdmissionResponse));
            }
        };
        Consumer<? super HostelNewAdmissionResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel$$ExternalSyntheticLambda6
            ...
            public final void accept(Object obj) {
                HostelNewViewModel.getHostelAdmissionFee$lambda$0(function1, obj);
            }
        };
        final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel.getHostelAdmissionFee.2
            ...
            public final void invoke2(Throwable th) {
                HostelNewViewModel.this.hostelAdmissionResponse.postValue(Resource.INSTANCE.exception(AppConstant.ERROR_MSG));
            }
        };
        compositeDisposable.add(singleObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel$$ExternalSyntheticLambda7
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                HostelNewViewModel.getHostelAdmissionFee$lambda$1(function12, obj);
            }
        }));
    }
    ...
    public final void getHostelMonthlyFee() {
        ...
        final Function1<HostelNewMonthlyResponse, Unit> function1 = new Function1<HostelNewMonthlyResponse, Unit>() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel.getHostelMonthlyFee.1
            ...
            public final void invoke2(HostelNewMonthlyResponse hostelNewMonthlyResponse) {
                HostelNewViewModel.this.hostelMonthlyResponse.postValue(Resource.INSTANCE.success(hostelNewMonthlyResponse));
            }
        };
        Consumer<? super HostelNewMonthlyResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel$$ExternalSyntheticLambda8
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                HostelNewViewModel.getHostelMonthlyFee$lambda$2(function1, obj);
            }
        };
        final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel.getHostelMonthlyFee.2
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Throwable th) {
                HostelNewViewModel.this.hostelMonthlyResponse.postValue(Resource.INSTANCE.exception(AppConstant.ERROR_MSG));
            }
        };
        compositeDisposable.add(singleObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel$$ExternalSyntheticLambda9
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                HostelNewViewModel.getHostelMonthlyFee$lambda$3(function12, obj);
            }
        }));
    }
    ...
    public final void getHostelHistory() {
        ...
        CompositeDisposable compositeDisposable = this.compositeDisposable;
        Single<HostelNewHistoryResponse> singleObserveOn = this.hostelRepository.getHostelHistoryNewApiCall().subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
        final Function1<HostelNewHistoryResponse, Unit> function1 = new Function1<HostelNewHistoryResponse, Unit>() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel.getHostelHistory.1
            ...
            public final void invoke2(HostelNewHistoryResponse hostelNewHistoryResponse) {
                HostelNewViewModel.this.hostelHistoryResponse.postValue(Resource.INSTANCE.success(hostelNewHistoryResponse));
            }
        };
        Consumer<? super HostelNewHistoryResponse> consumer = new Consumer() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel$$ExternalSyntheticLambda4
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                HostelNewViewModel.getHostelHistory$lambda$4(function1, obj);
            }
        };
        final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel.getHostelHistory.2
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Throwable th) {
                HostelNewViewModel.this.hostelHistoryResponse.postValue(Resource.INSTANCE.exception(AppConstant.ERROR_MSG));
            }
        };
        compositeDisposable.add(singleObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel$$ExternalSyntheticLambda5
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                HostelNewViewModel.getHostelHistory$lambda$5(function12, obj);
            }
        }));
    }
    ...
    public final void getHostelPay(Map<String, String> feeCollection, Map<String, String> feeReceipt) {
        ...
        CompositeDisposable compositeDisposable = this.compositeDisposable;
        Single<HostelNewPay> singleObserveOn = this.hostelRepository.getHostelFeeNewPayApiCall(feeCollection, feeReceipt).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
        final Function1<HostelNewPay, Unit> function1 = new Function1<HostelNewPay, Unit>() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel.getHostelPay.1
            ...
            public final void invoke2(HostelNewPay hostelNewPay) {
                HostelNewViewModel.this.hostelPayResponse.postValue(Resource.INSTANCE.success(hostelNewPay));
            }
        };
        Consumer<? super HostelNewPay> consumer = new Consumer() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel$$ExternalSyntheticLambda2
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                HostelNewViewModel.getHostelPay$lambda$6(function1, obj);
            }
        };
        final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel.getHostelPay.2
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Throwable th) {
                HostelNewViewModel.this.hostelPayResponse.postValue(Resource.INSTANCE.exception(AppConstant.ERROR_MSG));
            }
        };
        compositeDisposable.add(singleObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel$$ExternalSyntheticLambda3
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                HostelNewViewModel.getHostelPay$lambda$7(function12, obj);
            }
        }));
    }
    ...
    public final void getHostelStatus() {
        ...
        CompositeDisposable compositeDisposable = this.compositeDisposable;
        Single<HostelStatusNew> singleObserveOn = this.hostelRepository.getHostelStatusNewApiCall().subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
        final Function1<HostelStatusNew, Unit> function1 = new Function1<HostelStatusNew, Unit>() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel.getHostelStatus.1
            ...
            public final void invoke2(HostelStatusNew hostelStatusNew) {
                HostelNewViewModel.this.hostelStatusResponse.postValue(Resource.INSTANCE.success(hostelStatusNew));
            }
        };
        Consumer<? super HostelStatusNew> consumer = new Consumer() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel$$ExternalSyntheticLambda0
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                HostelNewViewModel.getHostelStatus$lambda$8(function1, obj);
            }
        };
        final Function1<Throwable, Unit> function12 = new Function1<Throwable, Unit>() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel.getHostelStatus.2
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Throwable th) {
                HostelNewViewModel.this.hostelStatusResponse.postValue(Resource.INSTANCE.exception(AppConstant.ERROR_MSG));
            }
        };
        compositeDisposable.add(singleObserveOn.subscribe(consumer, new Consumer() { // from class: in.etuwa.app.ui.hostelnew.HostelNewViewModel$$ExternalSyntheticLambda1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                HostelNewViewModel.getHostelStatus$lambda$9(function12, obj);
            }
        }));
    }
