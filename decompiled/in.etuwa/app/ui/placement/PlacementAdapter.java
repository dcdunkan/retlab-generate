...
public final class PlacementAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View inflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_placement, parent, false);
    ...
    public final class ViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            ...
            try {
                Object obj = this.this$0.placements.get(position);
                Intrinsics.checkNotNullExpressionValue(obj, "placements[position]");
                final Placement placement = (Placement) obj;
                this.company.setText(placement.getName());
                this.description.setText(placement.getDescription());
                this.date.setText("Date : " + placement.getDate());
                this.lastDate.setText("Last Date : " + placement.getLastDate());
                if (Intrinsics.areEqual(placement.getStatus(), "Registered")) {
                    this.apply.setText("Registered");
                    this.apply.setClickable(false);
                    this.apply.setBackgroundResource(R.drawable.shape_round_corner_fill_inactive);
                } else {
                    this.apply.setBackgroundResource(R.drawable.shape_round_corner_fill_dark);
                }
                TextView textView = this.apply;
                final PlacementAdapter placementAdapter = this.this$0;
                textView.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.placement.PlacementAdapter$ViewHolder$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        PlacementAdapter.ViewHolder.onBind$lambda$0(Placement.this, placementAdapter, view);
                    }
                });
                if (Intrinsics.areEqual(placement.getDescription(), "")) {
                    this.description.setVisibility(8);
                } else {
                    this.description.setVisibility(0);
                }
                if (!placement.getBtn()) {
                    String lowerCase = placement.getStatus().toLowerCase();
                    Intrinsics.checkNotNullExpressionValue(lowerCase, "toLowerCase(...)");
                    if (!Intrinsics.areEqual(lowerCase, "registered")) {
