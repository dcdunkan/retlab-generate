...
/* JADX INFO: compiled from: SyllabusAdapter.kt */
...
public final class SyllabusAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    /* JADX INFO: renamed from: isCovered, reason: from getter */
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View viewInflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_syllabus, parent, false);
        ...
        public void onBind(int position) {
            ...
            try {
                ...
                for (Topic topic : topics) {
                    if (Build.VERSION.SDK_INT >= 24) {
                        spannedFromHtml = Html.fromHtml(topic.getTopic(), 0);
                    } else {
                        spannedFromHtml = Html.fromHtml(topic.getTopic());
                    }
                    ...
                    textView.setText("• " + ((Object) spannedFromHtml));
