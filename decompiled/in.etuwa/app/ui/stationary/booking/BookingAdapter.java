...
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0002\u001c\u001dB\u0005¢\u0006\u0002\u0010\u0003J\u001e\u0010\n\u001a\u00020\u000b2\u0016\u0010\f\u001a\u0012\u0012\u0004\u0012\u00020\u00060\u0005j\b\u0012\u0004\u0012\u00020\u0006`\u0007J\u0006\u0010\r\u001a\u00020\u000bJ\b\u0010\u000e\u001a\u00020\u000fH\u0016J\u0010\u0010\u0010\u001a\u00020\u000f2\u0006\u0010\u0011\u001a\u00020\u000fH\u0016J\u000e\u0010\u0012\u001a\u00020\u000b2\u0006\u0010\u0011\u001a\u00020\u000fJ\u0018\u0010\u0013\u001a\u00020\u000b2\u0006\u0010\u0014\u001a\u00020\u00022\u0006\u0010\u0011\u001a\u00020\u000fH\u0016J\u0018\u0010\u0015\u001a\u00020\u00022\u0006\u0010\u0016\u001a\u00020\u00172\u0006\u0010\u0018\u001a\u00020\u000fH\u0016J\u0010\u0010\u0019\u001a\u00020\u000b2\b\u0010\u001a\u001a\u0004\u0018\u00010\u001bR\u001e\u0010\u0004\u001a\u0012\u0012\u0004\u0012\u00020\u00060\u0005j\b\u0012\u0004\u0012\u00020\u0006`\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\b\u001a\u0004\u0018\u00010\tX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u001e"}, d2 = {"Lin/etuwa/app/ui/stationary/booking/BookingAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Lin/etuwa/app/ui/base/BaseViewHolder;", "()V", "item", "Ljava/util/ArrayList;", "Lin/etuwa/app/data/model/stationary/StationaryItem;", "Lkotlin/collections/ArrayList;", ServiceSpecificExtraArgs.CastExtraArgs.LISTENER, "Lin/etuwa/app/ui/stationary/booking/BookingAdapter$StationaryListener;", "addItems", "", "list", "clearItems", "getItemCount", "", "getItemViewType", CommonCssConstants.POSITION, "notifyDataChanged", "onBindViewHolder", "holder", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "setStationaryCallBack", "context", "Lin/etuwa/app/ui/stationary/booking/BookingFragment;", "StationaryListener", "ViewHolder", "app_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class BookingAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public final class ViewHolder extends BaseViewHolder {
        ...
        private final TextView preBookBtn;
        ...
        public ViewHolder(BookingAdapter bookingAdapter, View itemView) {
            super(itemView);
            Intrinsics.checkNotNullParameter(itemView, "itemView");
            this.this$0 = bookingAdapter;
            this.productName = (TextView) itemView.findViewById(R.id.tv_product_name);
            this.category = (TextView) itemView.findViewById(R.id.tv_category);
            this.subcategory = (TextView) itemView.findViewById(R.id.tv_sub_category);
            this.price = (TextView) itemView.findViewById(R.id.tv_price);
            this.preBookBtn = (TextView) itemView.findViewById(R.id.pre_book_btn);
        }
        ...
        public void onBind(final int position) {
            ...
            try {
                ...
                StationaryItem stationaryItem = (StationaryItem) obj;
                this.productName.setText(stationaryItem.getName());
                this.category.setText(stationaryItem.getCategory_name());
                this.subcategory.setText(stationaryItem.getSubcategory_name());
                this.price.setText(stationaryItem.getPrice());
                TextView textView = this.preBookBtn;
        ...
        public static final void onBind$lambda$0(BookingAdapter this$0, int i, View view) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            StationaryListener stationaryListener = this$0.listener;
            if (stationaryListener != null) {
                stationaryListener.onPreBookClicked(i);
            }
        }
    }
    ...
    public final void addItems(ArrayList<StationaryItem> list) {
    ...
    public final void setStationaryCallBack(BookingFragment context) {
