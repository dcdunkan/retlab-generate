...
/* JADX INFO: compiled from: BookingHistoryAdapter.kt */
...
public final class BookingHistoryAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            View viewInflate2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_booking_receipt, parent, false);
            ...
            try {
                ...
                textView.setOnClickListener(new View.OnClickListener() { // from class: in.etuwa.app.ui.stationary.bookinghistory.BookingHistoryAdapter$ViewHolder$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(View view) {
                        BookingHistoryAdapter.ViewHolder.onBind$lambda$0(bookingHistoryAdapter, stationaryReceipt, view);
                    }
                });
