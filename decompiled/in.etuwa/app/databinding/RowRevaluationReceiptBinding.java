...
public final class RowRevaluationReceiptBinding implements ViewBinding {
    ...
    private RowRevaluationReceiptBinding(CardView rootView, LinearLayout answetLt, LinearLayout dueLayout, TextView examRevaluationAmnt, TextView examScriptAmnt, TextView examSubHead, LinearLayout revaluationLt) {
    ...
    public static RowRevaluationReceiptBinding inflate(LayoutInflater inflater) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            ...
                            if (linearLayout3 != null) {
                                return new RowRevaluationReceiptBinding((CardView) rootView, linearLayout, linearLayout2, textView, textView2, textView3, linearLayout3);
                            }
                        }
                    }
                }
