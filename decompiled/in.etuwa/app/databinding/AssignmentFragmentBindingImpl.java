...
public class AssignmentFragmentBindingImpl extends AssignmentFragmentBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.assi_filter, 2);
    ...
    @Override // in.etuwa.app.databinding.AssignmentFragmentBinding
    public void setAssignmentViewModel(AssignmentViewModel AssignmentViewModel) {
        this.mAssignmentViewModel = AssignmentViewModel;
    }
