...
public class ChatFragmentBindingImpl extends ChatFragmentBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.rv_chat, 3);
    }

    public ChatFragmentBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private ChatFragmentBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.ChatFragmentBinding
