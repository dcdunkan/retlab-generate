...
public class FragmentRegistrationBindingImpl extends FragmentRegistrationBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.new_registration_btn, 4);
    }

    public FragmentRegistrationBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private FragmentRegistrationBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.FragmentRegistrationBinding
