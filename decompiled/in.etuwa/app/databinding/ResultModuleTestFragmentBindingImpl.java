...
public class ResultModuleTestFragmentBindingImpl extends ResultModuleTestFragmentBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.module_sem_tv, 2);
        sparseIntArray.put(R.id.module_layout, 3);
        sparseIntArray.put(R.id.spinner_sem, 4);
        sparseIntArray.put(R.id.swipe_layout, 5);
        sparseIntArray.put(R.id.rv_result_module_test, 6);
        sparseIntArray.put(R.id.fab_module_result_semester, 7);
    }

    public ResultModuleTestFragmentBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }

    private ResultModuleTestFragmentBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.ResultModuleTestFragmentBinding
    public void setResultModuleTestViewModel(ResultModuleTestViewModel ResultModuleTestViewModel) {
        this.mResultModuleTestViewModel = ResultModuleTestViewModel;
    }
