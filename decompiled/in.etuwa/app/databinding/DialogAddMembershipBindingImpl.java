...
public class DialogAddMembershipBindingImpl extends DialogAddMembershipBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.spinner_type, 5);
        sparseIntArray.put(R.id.spinner_since, 6);
        sparseIntArray.put(R.id.et_membership_id, 7);
        sparseIntArray.put(R.id.et_description, 8);
    ...
    public DialogAddMembershipBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }

    private DialogAddMembershipBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (TextView) bindings[12], (LinearLayout) bindings[9], (TextView) bindings[10], (TextView) bindings[11], (TextInputEditText) bindings[8], (TextInputEditText) bindings[7], (TextInputEditText) bindings[4], (TextView) bindings[16], (CardView) bindings[14], (TextView) bindings[3], (Spinner) bindings[6], (Spinner) bindings[5], (TextView) bindings[13], (ProgressBar) bindings[15]);
        this.mDirtyFlags = -1L;
    ...
    @Override // in.etuwa.app.databinding.DialogAddMembershipBinding
    public void setAddMembershipViewModel(AddMembershipViewModel AddMembershipViewModel) {
        this.mAddMembershipViewModel = AddMembershipViewModel;
    }
