...
public final class RowCalendarDaysBinding implements ViewBinding {
    ...
    private RowCalendarDaysBinding(LinearLayout rootView, ImageView dayMarker, TextView tvDay) {
    ...
    public static RowCalendarDaysBinding inflate(LayoutInflater inflater) {
    ...
    public static RowCalendarDaysBinding bind(View rootView) {
        int i = R.id.dayMarker;
        ImageView imageView = (ImageView) ViewBindings.findChildViewById(rootView, i);
        if (imageView != null) {
            i = R.id.tvDay;
            TextView textView = (TextView) ViewBindings.findChildViewById(rootView, i);
            if (textView != null) {
                return new RowCalendarDaysBinding((LinearLayout) rootView, imageView, textView);
            }
        }
