...
public class EvaluationFragmentBindingImpl extends EvaluationFragmentBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.rv_evaluation, 3);
    }

    public EvaluationFragmentBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private EvaluationFragmentBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.EvaluationFragmentBinding
