...
public final class LayoutSemesterListBinding implements ViewBinding {
    ...
    private LayoutSemesterListBinding(LinearLayout rootView, TextView semName) {
    ...
    public static LayoutSemesterListBinding inflate(LayoutInflater inflater) {
    ...
    public static LayoutSemesterListBinding bind(View rootView) {
        ...
        if (textView != null) {
            return new LayoutSemesterListBinding((LinearLayout) rootView, textView);
        }
