...
public final class RowHostelMitsAdmissionBinding implements ViewBinding {
    ...
    private RowHostelMitsAdmissionBinding(LinearLayout rootView, TextView hostelFeeDetail, TextView hostelInstallment, TextView hostelMainAmount, TextView hostelMainBalance, TextView hostelMainPaid, TextView hostelMainScholarship, CheckBox installmentCheck, LinearLayout linearHost) {
    ...
    public static RowHostelMitsAdmissionBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RowHostelMitsAdmissionBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.row_hostel_mits_admission, parent, false);
        if (attachToParent) {
    ...
    public static RowHostelMitsAdmissionBinding bind(View rootView) {
                        ...
                        if (textView5 != null) {
                            ...
                            if (textView6 != null) {
                                ...
                                if (checkBox != null) {
                                    ...
                                    return new RowHostelMitsAdmissionBinding(linearLayout, textView, textView2, textView3, textView4, textView5, textView6, checkBox, linearLayout);
                                }
                            }
                        }
                    }
