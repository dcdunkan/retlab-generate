...
public class FragmentHostelFeePalaiBindingImpl extends FragmentHostelFeePalaiBinding {
    ...
    public FragmentHostelFeePalaiBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }

    private FragmentHostelFeePalaiBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.FragmentHostelFeePalaiBinding
    public void setPalaiHostelViewModel(PalaiHostelViewModel PalaiHostelViewModel) {
        this.mPalaiHostelViewModel = PalaiHostelViewModel;
    }
