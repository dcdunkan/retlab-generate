...
public class FragmentCourseSurveyBindingImpl extends FragmentCourseSurveyBinding {
    ...
    public FragmentCourseSurveyBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private FragmentCourseSurveyBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.FragmentCourseSurveyBinding
    public void setSurveyViewModel(CourseEvaluationSurveyViewModel SurveyViewModel) {
