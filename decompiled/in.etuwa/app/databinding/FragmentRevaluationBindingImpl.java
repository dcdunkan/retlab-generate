...
public class FragmentRevaluationBindingImpl extends FragmentRevaluationBinding {
    ...
    public FragmentRevaluationBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }

    private FragmentRevaluationBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.FragmentRevaluationBinding
    public void setRevaluationViewModel(RevaluationViewModel RevaluationViewModel) {
        this.mRevaluationViewModel = RevaluationViewModel;
    }
