...
public class DialogAddUpdatePublicationBindingImpl extends DialogAddUpdatePublicationBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.et_journel, 5);
        sparseIntArray.put(R.id.et_conference, 6);
        sparseIntArray.put(R.id.spinner_year, 7);
        sparseIntArray.put(R.id.spinner_index, 8);
    ...
    public DialogAddUpdatePublicationBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }

    private DialogAddUpdatePublicationBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (TextView) bindings[12], (LinearLayout) bindings[9], (TextView) bindings[10], (TextView) bindings[11], (TextInputEditText) bindings[6], (TextInputEditText) bindings[5], (TextInputEditText) bindings[4], (TextView) bindings[16], (CardView) bindings[14], (TextView) bindings[3], (Spinner) bindings[8], (Spinner) bindings[7], (TextView) bindings[13], (ProgressBar) bindings[15]);
        this.mDirtyFlags = -1L;
    ...
    @Override // in.etuwa.app.databinding.DialogAddUpdatePublicationBinding
    public void setAddPublicationViewModel(AddPublicationViewModel AddPublicationViewModel) {
        this.mAddPublicationViewModel = AddPublicationViewModel;
    }
