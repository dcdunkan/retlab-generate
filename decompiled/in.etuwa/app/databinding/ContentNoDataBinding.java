...
public final class ContentNoDataBinding implements ViewBinding {
    ...
    private ContentNoDataBinding(ConstraintLayout rootView, TextView viewNoData) {
    ...
    public static ContentNoDataBinding inflate(LayoutInflater inflater) {
    ...
    public static ContentNoDataBinding bind(View rootView) {
        int i = R.id.viewNoData;
        TextView textView = (TextView) ViewBindings.findChildViewById(rootView, i);
        if (textView != null) {
            return new ContentNoDataBinding((ConstraintLayout) rootView, textView);
        }
