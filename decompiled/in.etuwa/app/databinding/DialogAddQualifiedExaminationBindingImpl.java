...
public class DialogAddQualifiedExaminationBindingImpl extends DialogAddQualifiedExaminationBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.et_score, 5);
        sparseIntArray.put(R.id.spinner_year, 6);
    ...
    public DialogAddQualifiedExaminationBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private DialogAddQualifiedExaminationBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (TextView) bindings[10], (LinearLayout) bindings[7], (TextView) bindings[8], (TextView) bindings[9], (TextInputEditText) bindings[4], (TextInputEditText) bindings[5], (TextView) bindings[14], (CardView) bindings[12], (TextView) bindings[3], (Spinner) bindings[6], (TextView) bindings[11], (ProgressBar) bindings[13]);
        this.mDirtyFlags = -1L;
    ...
    @Override // in.etuwa.app.databinding.DialogAddQualifiedExaminationBinding
    public void setAddQualifiedExaminationViewModel(AddQualifiedExaminationViewModel AddQualifiedExaminationViewModel) {
        this.mAddQualifiedExaminationViewModel = AddQualifiedExaminationViewModel;
    }
