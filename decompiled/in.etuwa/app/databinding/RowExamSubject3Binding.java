...
public final class RowExamSubject3Binding implements ViewBinding {
    ...
    private RowExamSubject3Binding(MaterialCardView rootView, LinearLayout comletionLayout, LinearLayout dueLayout, TextView subjectHead, MaterialButton viewBtn, MaterialButton viewRegisterBtn) {
    ...
    public static RowExamSubject3Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.row_exam_subject3, parent, false);
        if (attachToParent) {
                ...
                if (textView != null) {
                    ...
                    if (materialButton != null) {
                        ...
                        if (materialButton2 != null) {
                            return new RowExamSubject3Binding((MaterialCardView) rootView, linearLayout, linearLayout2, textView, materialButton, materialButton2);
                        }
                    }
                }
            }
