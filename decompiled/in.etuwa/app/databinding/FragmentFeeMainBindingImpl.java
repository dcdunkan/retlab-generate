...
public class FragmentFeeMainBindingImpl extends FragmentFeeMainBinding {
    ...
    private FragmentFeeMainBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (LinearLayout) bindings[1], (LinearLayout) bindings[9], (LinearLayout) bindings[4], (LinearLayout) bindings[6], (LinearLayout) bindings[5], (MaterialTextView) bindings[3], (LinearLayout) bindings[2], (LinearLayout) bindings[8], (LinearLayout) bindings[7]);
        this.mDirtyFlags = -1L;
