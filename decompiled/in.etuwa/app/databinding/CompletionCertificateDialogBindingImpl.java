...
public class CompletionCertificateDialogBindingImpl extends CompletionCertificateDialogBinding {
    ...
    public CompletionCertificateDialogBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }

    private CompletionCertificateDialogBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.CompletionCertificateDialogBinding
    public void setCompletionCertificateDialogViewModel(CompletionCertificateDialogViewModel CompletionCertificateDialogViewModel) {
        this.mCompletionCertificateDialogViewModel = CompletionCertificateDialogViewModel;
    }
