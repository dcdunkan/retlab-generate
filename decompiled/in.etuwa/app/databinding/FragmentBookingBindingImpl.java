...
public class FragmentBookingBindingImpl extends FragmentBookingBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.rv_booking, 3);
    }

    public FragmentBookingBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private FragmentBookingBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, Object variable) {
        ...
        setBookingViewModel((BookingViewModel) variable);
        return true;
    }

    @Override // in.etuwa.app.databinding.FragmentBookingBinding
