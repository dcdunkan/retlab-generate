...
public class DialogHostelNewConfirmBindingImpl extends DialogHostelNewConfirmBinding {
    ...
    public DialogHostelNewConfirmBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private DialogHostelNewConfirmBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.DialogHostelNewConfirmBinding
    public void setHostelNewConfirmViewModel(HostelNewConfirmViewModel HostelNewConfirmViewModel) {
        this.mHostelNewConfirmViewModel = HostelNewConfirmViewModel;
    }
