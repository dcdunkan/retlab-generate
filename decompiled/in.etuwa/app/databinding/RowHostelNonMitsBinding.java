...
public final class RowHostelNonMitsBinding implements ViewBinding {
    ...
    private RowHostelNonMitsBinding(LinearLayout rootView, TextView hostelFeeDetail, TextView hostelInstallment, TextView hostelMainAmount, TextView hostelMainBalance, TextView hostelMainPaid, TextView hostelMainScholarship, CheckBox installmentCheck, LinearLayout linearHost) {
    ...
    public static RowHostelNonMitsBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RowHostelNonMitsBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.row_hostel_non_mits, parent, false);
        if (attachToParent) {
    ...
    public static RowHostelNonMitsBinding bind(View rootView) {
                        ...
                        if (textView5 != null) {
                            ...
                            if (textView6 != null) {
                                ...
                                if (checkBox != null) {
                                    ...
                                    return new RowHostelNonMitsBinding(linearLayout, textView, textView2, textView3, textView4, textView5, textView6, checkBox, linearLayout);
                                }
                            }
                        }
                    }
