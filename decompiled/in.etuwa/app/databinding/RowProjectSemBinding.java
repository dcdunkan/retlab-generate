...
public final class RowProjectSemBinding implements ViewBinding {
    ...
    private RowProjectSemBinding(LinearLayout rootView, TextView detailsTv, TextView slNo, TextView titleTv) {
    ...
    public static RowProjectSemBinding inflate(LayoutInflater inflater) {
    ...
    public static RowProjectSemBinding bind(View rootView) {
        ...
        if (textView != null) {
            ...
            if (textView2 != null) {
                ...
                if (textView3 != null) {
                    return new RowProjectSemBinding((LinearLayout) rootView, textView, textView2, textView3);
                }
            }
        }
