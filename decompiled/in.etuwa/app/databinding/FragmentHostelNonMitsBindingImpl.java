...
public class FragmentHostelNonMitsBindingImpl extends FragmentHostelNonMitsBinding {
    ...
    public FragmentHostelNonMitsBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }

    private FragmentHostelNonMitsBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.FragmentHostelNonMitsBinding
    public void setHostelNonMitsViewModel(HostelNonMitsViewModel HostelNonMitsViewModel) {
        this.mHostelNonMitsViewModel = HostelNonMitsViewModel;
    }
