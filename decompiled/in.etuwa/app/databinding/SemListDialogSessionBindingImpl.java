...
public class SemListDialogSessionBindingImpl extends SemListDialogSessionBinding {
    ...
    public SemListDialogSessionBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private SemListDialogSessionBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.SemListDialogSessionBinding
    public void setSemListDialogViewModelTwo(SemListDialogViewModelTwo SemListDialogViewModelTwo) {
        this.mSemListDialogViewModelTwo = SemListDialogViewModelTwo;
    }
