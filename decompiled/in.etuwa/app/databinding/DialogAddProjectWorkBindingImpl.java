...
public class DialogAddProjectWorkBindingImpl extends DialogAddProjectWorkBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.spinner_since, 5);
        sparseIntArray.put(R.id.et_details, 6);
    ...
    public DialogAddProjectWorkBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }

    private DialogAddProjectWorkBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (TextView) bindings[10], (LinearLayout) bindings[7], (TextView) bindings[8], (TextView) bindings[9], (TextInputEditText) bindings[6], (TextView) bindings[14], (CardView) bindings[12], (TextView) bindings[3], (Spinner) bindings[5], (Spinner) bindings[4], (TextView) bindings[11], (ProgressBar) bindings[13]);
        this.mDirtyFlags = -1L;
    ...
    @Override // in.etuwa.app.databinding.DialogAddProjectWorkBinding
    public void setAddProjectWorkViewModel(AddProjectWorkViewModel AddProjectWorkViewModel) {
        this.mAddProjectWorkViewModel = AddProjectWorkViewModel;
    }
