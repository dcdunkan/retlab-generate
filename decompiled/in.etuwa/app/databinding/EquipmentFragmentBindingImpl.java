...
public class EquipmentFragmentBindingImpl extends EquipmentFragmentBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.rv_lab_equipment, 3);
    }

    public EquipmentFragmentBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private EquipmentFragmentBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.EquipmentFragmentBinding
    public void setEquipmentViewModel(EquipmentViewModel EquipmentViewModel) {
        this.mEquipmentViewModel = EquipmentViewModel;
    }
