...
public final class RowHostelNonMitsAdmisssionBinding implements ViewBinding {
    ...
    private RowHostelNonMitsAdmisssionBinding(LinearLayout rootView, TextView hostelFeeDetail, TextView hostelInstallment, TextView hostelMainAmount, TextView hostelMainBalance, TextView hostelMainPaid, TextView hostelMainScholarship, CheckBox installmentCheck, LinearLayout linearHost) {
    ...
    public static RowHostelNonMitsAdmisssionBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RowHostelNonMitsAdmisssionBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.row_hostel_non_mits_admisssion, parent, false);
        if (attachToParent) {
    ...
    public static RowHostelNonMitsAdmisssionBinding bind(View rootView) {
                        ...
                        if (textView5 != null) {
                            ...
                            if (textView6 != null) {
                                ...
                                if (checkBox != null) {
                                    ...
                                    return new RowHostelNonMitsAdmisssionBinding(linearLayout, textView, textView2, textView3, textView4, textView5, textView6, checkBox, linearLayout);
                                }
                            }
                        }
                    }
