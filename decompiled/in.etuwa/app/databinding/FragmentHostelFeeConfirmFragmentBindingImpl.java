...
public class FragmentHostelFeeConfirmFragmentBindingImpl extends FragmentHostelFeeConfirmFragmentBinding {
    ...
    public FragmentHostelFeeConfirmFragmentBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private FragmentHostelFeeConfirmFragmentBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.FragmentHostelFeeConfirmFragmentBinding
    public void setHostelFeeConfirmViewModel(HostelFeeConfirmViewModel HostelFeeConfirmViewModel) {
        this.mHostelFeeConfirmViewModel = HostelFeeConfirmViewModel;
    }
