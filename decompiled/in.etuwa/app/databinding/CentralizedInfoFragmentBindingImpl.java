...
public class CentralizedInfoFragmentBindingImpl extends CentralizedInfoFragmentBinding {
    ...
    public CentralizedInfoFragmentBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private CentralizedInfoFragmentBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.CentralizedInfoFragmentBinding
    public void setCentralizedInfoViewModel(CentralizedInfoViewModel CentralizedInfoViewModel) {
        this.mCentralizedInfoViewModel = CentralizedInfoViewModel;
    }
