...
public class FragmentHostelMitsBindingImpl extends FragmentHostelMitsBinding {
    ...
    public FragmentHostelMitsBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }

    private FragmentHostelMitsBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.FragmentHostelMitsBinding
    public void setHostelMitsViewModel(HostelMitsViewModel HostelMitsViewModel) {
        this.mHostelMitsViewModel = HostelMitsViewModel;
    }
