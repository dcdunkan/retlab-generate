...
public final class RowTechSurveyBinding implements ViewBinding {
    ...
    private RowTechSurveyBinding(CardView rootView, TextView surTeachBtn, TextView surTeachName, TextView surTeachStatus, TextView surTeachSubName) {
    ...
    public static RowTechSurveyBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.row_tech_survey, parent, false);
        if (attachToParent) {
        ...
        if (textView != null) {
            ...
            if (textView2 != null) {
                ...
                if (textView3 != null) {
                    ...
                    if (textView4 != null) {
                        return new RowTechSurveyBinding((CardView) rootView, textView, textView2, textView3, textView4);
                    }
                }
            }
        }
