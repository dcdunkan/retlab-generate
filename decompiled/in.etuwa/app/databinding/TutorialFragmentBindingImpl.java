...
public class TutorialFragmentBindingImpl extends TutorialFragmentBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.rv_tutorial, 3);
    }

    public TutorialFragmentBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private TutorialFragmentBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.TutorialFragmentBinding
    public void setTutorialViewModel(TutorialViewModel TutorialViewModel) {
