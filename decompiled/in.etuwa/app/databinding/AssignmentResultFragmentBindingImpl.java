...
public class AssignmentResultFragmentBindingImpl extends AssignmentResultFragmentBinding {
    ...
    private AssignmentResultFragmentBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (MaterialCardView) bindings[3], (FloatingActionButton) bindings[7], (RecyclerView) bindings[6], (TextView) bindings[2], (Spinner) bindings[4], (SwipeRefreshLayout) bindings[5]);
        this.mDirtyFlags = -1L;
