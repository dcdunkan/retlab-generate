...
public class FragmentWebviewBindingImpl extends FragmentWebviewBinding {
    ...
    private FragmentWebviewBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (SwipeRefreshLayout) bindings[2], (WebView) bindings[3]);
        this.mDirtyFlags = -1L;
    ...
    @Override // in.etuwa.app.databinding.FragmentWebviewBinding
    public void setWebViewViewModel(WebViewViewModel WebViewViewModel) {
