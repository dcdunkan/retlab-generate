...
public final class RowSubjectCoverageBinding implements ViewBinding {
    ...
    private RowSubjectCoverageBinding(CardView rootView, LinearLayout topicView, TextView tvModuleName) {
    ...
    public static RowSubjectCoverageBinding inflate(LayoutInflater inflater) {
    ...
    public static RowSubjectCoverageBinding bind(View rootView) {
        int i = R.id.topic_view;
        LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(rootView, i);
        if (linearLayout != null) {
            i = R.id.tv_module_name;
            TextView textView = (TextView) ViewBindings.findChildViewById(rootView, i);
            if (textView != null) {
                return new RowSubjectCoverageBinding((CardView) rootView, linearLayout, textView);
            }
        }
