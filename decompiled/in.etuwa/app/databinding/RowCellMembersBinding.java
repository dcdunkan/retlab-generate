...
public final class RowCellMembersBinding implements ViewBinding {
    ...
    private RowCellMembersBinding(LinearLayout rootView, TextView cellLevel, TextView cellName) {
    ...
    public static RowCellMembersBinding inflate(LayoutInflater inflater) {
    ...
    public static RowCellMembersBinding bind(View rootView) {
        ...
        if (textView != null) {
            ...
            if (textView2 != null) {
                return new RowCellMembersBinding((LinearLayout) rootView, textView, textView2);
            }
        }
