...
public final class RowTutorialResultBinding implements ViewBinding {
    public final View assignmentIndicator;
    ...
    private RowTutorialResultBinding(MaterialCardView rootView, View assignmentIndicator, LinearLayout markContainer, TextView tvMark, TextView tvSub, TextView tvTitle) {
    ...
    public static RowTutorialResultBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.row_tutorial_result, parent, false);
        if (attachToParent) {
    ...
    public static RowTutorialResultBinding bind(View rootView) {
        int i = R.id.assignment_indicator;
            ...
            if (linearLayout != null) {
                ...
                if (textView != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            return new RowTutorialResultBinding((MaterialCardView) rootView, viewFindChildViewById, linearLayout, textView, textView2, textView3);
                        }
                    }
                }
            }
