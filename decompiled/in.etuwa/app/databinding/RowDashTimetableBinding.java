...
public final class RowDashTimetableBinding implements ViewBinding {
    ...
    private RowDashTimetableBinding(CardView rootView, TextView dashPeriod, TextView dashSub) {
        this.rootView = rootView;
        this.dashPeriod = dashPeriod;
        this.dashSub = dashSub;
    }
    ...
    public static RowDashTimetableBinding inflate(LayoutInflater inflater) {
    ...
    public static RowDashTimetableBinding bind(View rootView) {
        int i = R.id.dash_period;
        TextView textView = (TextView) ViewBindings.findChildViewById(rootView, i);
        if (textView != null) {
            i = R.id.dash_sub;
            TextView textView2 = (TextView) ViewBindings.findChildViewById(rootView, i);
            if (textView2 != null) {
                return new RowDashTimetableBinding((CardView) rootView, textView, textView2);
            }
        }
