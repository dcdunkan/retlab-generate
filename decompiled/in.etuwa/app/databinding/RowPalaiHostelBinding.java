...
public final class RowPalaiHostelBinding implements ViewBinding {
    ...
    private RowPalaiHostelBinding(LinearLayout rootView, TextView hostelFeeDetail, TextView hostelInstallment, TextView hostelMainAmount, TextView hostelMainBalance, TextView hostelMainPaid, CheckBox installmentCheck, LinearLayout linearHost) {
    ...
    public static RowPalaiHostelBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RowPalaiHostelBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.row_palai_hostel, parent, false);
        if (attachToParent) {
    ...
    public static RowPalaiHostelBinding bind(View rootView) {
                    ...
                    if (textView4 != null) {
                        ...
                        if (textView5 != null) {
                            ...
                            if (checkBox != null) {
                                ...
                                return new RowPalaiHostelBinding(linearLayout, textView, textView2, textView3, textView4, textView5, checkBox, linearLayout);
                            }
                        }
                    }
                }
