...
public final class RowPalaiHostelNewBinding implements ViewBinding {
    ...
    private RowPalaiHostelNewBinding(LinearLayout rootView, TextView hostelFeeDetail, TextView hostelInstallment, TextView hostelMainAmount, TextView hostelMainBalance, TextView hostelMainPaid, CheckBox installmentCheck, LinearLayout linearHost) {
    ...
    public static RowPalaiHostelNewBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static RowPalaiHostelNewBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.row_palai_hostel_new, parent, false);
        if (attachToParent) {
    ...
    public static RowPalaiHostelNewBinding bind(View rootView) {
                    ...
                    if (textView4 != null) {
                        ...
                        if (textView5 != null) {
                            ...
                            if (checkBox != null) {
                                ...
                                return new RowPalaiHostelNewBinding(linearLayout, textView, textView2, textView3, textView4, textView5, checkBox, linearLayout);
                            }
                        }
                    }
                }
