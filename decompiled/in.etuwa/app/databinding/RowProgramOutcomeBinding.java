...
public final class RowProgramOutcomeBinding implements ViewBinding {
    ...
    private RowProgramOutcomeBinding(MaterialCardView rootView, TextView tvDescription, TextView tvHead) {
    ...
    public static RowProgramOutcomeBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.row_program_outcome, parent, false);
        if (attachToParent) {
    ...
    public static RowProgramOutcomeBinding bind(View rootView) {
        ...
        if (textView != null) {
            ...
            if (textView2 != null) {
                return new RowProgramOutcomeBinding((MaterialCardView) rootView, textView, textView2);
            }
        }
