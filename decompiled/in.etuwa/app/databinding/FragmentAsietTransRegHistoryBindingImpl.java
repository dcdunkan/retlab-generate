...
public class FragmentAsietTransRegHistoryBindingImpl extends FragmentAsietTransRegHistoryBinding {
    ...
    public FragmentAsietTransRegHistoryBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private FragmentAsietTransRegHistoryBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.FragmentAsietTransRegHistoryBinding
