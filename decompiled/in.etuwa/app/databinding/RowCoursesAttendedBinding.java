...
public final class RowCoursesAttendedBinding implements ViewBinding {
    ...
    private RowCoursesAttendedBinding(CardView rootView, TextView academicTv, TextView achievementsTv, LinearLayout comletionLayout, TextView deleteBtn, TextView durationTv, TextView editBtn, TextView editBtnHr, TextView fromDate, TextView organisedBy, TextView slNo, TextView titleTv, TextView toDateTv, TextView viewBtnHr) {
        this.rootView = rootView;
        this.academicTv = academicTv;
    ...
    public static RowCoursesAttendedBinding inflate(LayoutInflater inflater) {
    ...
    public static RowCoursesAttendedBinding bind(View rootView) {
        int i = R.id.academic_tv;
        TextView textView = (TextView) ViewBindings.findChildViewById(rootView, i);
        if (textView != null) {
            i = R.id.achievements_tv;
                                            ...
                                            if (textView9 != null) {
                                                ...
                                                if (textView10 != null) {
                                                    ...
                                                    if (textView11 != null) {
                                                        ...
                                                        if (textView12 != null) {
                                                            return new RowCoursesAttendedBinding((CardView) rootView, textView, textView2, linearLayout, textView3, textView4, textView5, textView6, textView7, textView8, textView9, textView10, textView11, textView12);
                                                        }
                                                    }
                                                }
                                            }
