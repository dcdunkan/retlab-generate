...
public class FragmentTransportFeeBindingImpl extends FragmentTransportFeeBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.rv_transport_fee, 2);
    }

    public FragmentTransportFeeBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private FragmentTransportFeeBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // in.etuwa.app.databinding.FragmentTransportFeeBinding
